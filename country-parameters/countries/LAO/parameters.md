...
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  - survey_labels: 1-Vientiane | 1-Vientiane capital
    ...
    gmd_subnatid1: LAO_2015_GAUL1_1768
    ...
    geo_id: '1768'
    geo_nvar: ADM1_NAME
    geo_name: Vientiane capital
    source_row: 8902
  - survey_labels: 2-North
    survey_variables: subnatid1
    gmd_subnatid1: LAO_2015_GAULx_2
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '2'
    geo_nvar: ADM1_NAME
    geo_name: Bokeo & Houaphan & Louangphabang & Louang-Namtha & Oudomxai & Phongsali
      & Xaignabouli
    source_row: 8903
  - survey_labels: 3-Central
    survey_variables: subnatid1
    gmd_subnatid1: LAO_2015_GAULx_3
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '3'
    geo_nvar: ADM1_NAME
    geo_name: Bolikhamxai & Khammouan & Savannakhet & Vientiane & Xiangkhouang
    source_row: 8904
  - survey_labels: 4-South
    survey_variables: subnatid1
    gmd_subnatid1: LAO_2015_GAULx_4
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '4'
    geo_nvar: ADM1_NAME
    geo_name: Attapu & Champasak & Salavan & Xekong
    source_row: 8905
  - survey_labels: 10-Vientiane
  ...
  - survey_labels: 11-Bolikhamxai
    ...
    geo_id: '1755'
    geo_nvar: ADM1_NAME
    geo_name: Bolikhamxai
    source_row: 8916
  - survey_labels: 12-Khammouan
    survey_variables: subnatid2
    gmd_subnatid1: ''
  ...
  - survey_labels: 3-Louang-Namtha
    ...
    geo_id: '1760'
    geo_nvar: ADM1_NAME
    geo_name: Louang-Namtha
    source_row: 8924
  - survey_labels: 4-Oudomxai
    survey_variables: subnatid2
    gmd_subnatid1: ''
  ...
  - survey_labels: 6-Louangphabang
    ...
    geo_id: '1759'
    geo_nvar: ADM1_NAME
    geo_name: Louangphabang
    source_row: 8927
  - survey_labels: 7-Houaphan
    survey_variables: subnatid2
    gmd_subnatid1: ''
  ...
  - survey_labels: 8-Xaignabouli
    ...
    geo_id: '1765'
    geo_nvar: ADM1_NAME
    geo_name: Xaignabouli
    source_row: 8929
  - survey_labels: 9-Xiangkhouang
    survey_variables: subnatid2
    gmd_subnatid1: ''
...
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  - survey_labels: 10-Vientiane
    ...
    geo_name: Vientiane
    source_row: 8936
  - survey_labels: 11-Bolikhamxai | 11-Bolikhamxay
    survey_variables: subnatid2
    gmd_subnatid1: ''
    ...
    geo_name: Bolikhamxai
    source_row: 8937
  - survey_labels: 12-Khammouan | 12-Khammuane
    survey_variables: subnatid2
    gmd_subnatid1: ''
  ...
  - survey_labels: 14-Salavan
    ...
    geo_name: Saravan
    source_row: 8940
  - survey_labels: 15-Sekong | 15-Xekong
    survey_variables: subnatid2
    gmd_subnatid1: ''
  ...
  - survey_labels: 16-Champasack | 16-Champasak
    ...
    geo_name: Champasak
    source_row: 8942
  - survey_labels: 17-Attapeu | 17-Attapu
    survey_variables: subnatid2
    gmd_subnatid1: ''
  ...
  - survey_labels: 3-Louang-Namtha | 3-Luangnamtha
    ...
    geo_name: Louang Namtha
    source_row: 8946
  - survey_labels: 4-Oudomxai | 4-Oudumxay
    survey_variables: subnatid2
    gmd_subnatid1: ''
  ...
  - survey_labels: 5-Bokeo
    ...
    geo_name: Bokeo
    source_row: 8948
  - survey_labels: 6-Louangphabang | 6-Luang Prabang
    survey_variables: subnatid2
    gmd_subnatid1: ''
    ...
    geo_id: LAO.8_1
    geo_nvar: NAME_1
    geo_name: Louangphrabang
    source_row: 8949
  - survey_labels: 7-Houaphan | 7-Huaphan
    survey_variables: subnatid2
    gmd_subnatid1: ''
  ...
  - survey_labels: 8-Xayabury
    ...
    geo_id: LAO.15_1
    geo_nvar: NAME_1
    geo_name: Xaignabouri
    source_row: 8951
  - survey_labels: 9-Xiangkhouang | 9-Xiengkhuang
    survey_variables: subnatid2
    gmd_subnatid1: ''
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - source_category_code: flush_pour_type_toilet_connected_elsewhere_connection_unkno
    national_label_en: flush/pour type toilet connected elsewhere/ connection unkno
    national_label_local: to elsewhere
    jmp_classification: Flush and pour flush > to elsewhere
    jmp_id: flush_and_pour_flush.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - source_category_code: flush_pour_flush_ot_pit_latrine
    national_label_en: Flush/pour flush ot pit latrine
  ...
  - source_category_code: normal_toilet
    national_label_en: Normal toilet
...
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - source_category_code: well_borehole_protected
    national_label_en: Well / borehole protected
    national_label_local: Protected well
    jmp_classification: Ground water > Protected well
    jmp_id: ground_water.protected_well
    gmd_target: protected_well
  ...
  - source_category_code: well_borehole_unprotected
    national_label_en: Well / borehole unprotected
    national_label_local: Unprotected well
    jmp_classification: Ground water > Unprotected well
    jmp_id: ground_water.unprotected_well
    gmd_target: unprotected_well
  ...
  - source_category_code: gravity_fed_system_gfs
    national_label_en: Gravity Fed System (GFS)
    national_label_local: Other
  ...
  - source_category_code: bw_without_improved_sources
    national_label_en: BW without improved sources
  ...
  - source_category_code: rainwater_from_tank_jar
    national_label_en: Rainwater from tank/jar
    national_label_local: Covered cistern/tank
    jmp_classification: Rainwater > Covered cistern/tank
    jmp_id: rainwater.covered_cistern_tank
    gmd_target: rainwater
  ...
  - source_category_code: surface_water_stream_lake_etc
    national_label_en: surface water (stream, lake, etc)
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - source_category_code: piped_water_in_outside
    national_label_en: Piped water in/outside
