...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - national_label_en: Pré-primaire
    ...
    source_row: 7
  - national_label_en: Classe préparatoire
    national_label_local: السنة التحضيرية
    entry_age: 5
    duration_years: 1
    isced_level: '0'
    isced_label: ISCED 0 Early childhood education
    ...
    gmd_educat7_target: none
    source_row: 8
  - national_label_en: Étape primaire de l'enseignement de base
    national_label_local: المرحلة الابتدائية من التعليم الأساسي
    entry_age: 6
    duration_years: 6
    isced_level: '1'
    ...
    source_row: 9
  - national_label_en: Étape préparatoire de l'enseignement de base (enseignement
      général)
    national_label_local: المرحلة الإعدادية من التعليم الأساسي (تعليم عام)
    entry_age: 12
    duration_years: 3
    isced_level: '2'
    ...
    source_row: 10
  - national_label_en: Programme de compétence
    national_label_local: برنامج المهارة
    entry_age: 13
    duration_years: 2
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
  ...
  - national_label_en: Étape préparatoire de l'enseignement de base (enseignement
      technique)
    national_label_local: المرحلة الإعدادية من التعليم الأساسي  (تعليم تقني)
    entry_age: 13
    duration_years: 2
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
  ...
  - national_label_en: Certificat d'Aptitude professionnelle (CAP)
    national_label_local: شهادة الكفاءة المهنية
    entry_age: 15
    duration_years: 2
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: Brevet de Technicien Professionnel (BTP)
    national_label_local: مؤهل التقني المهني
    entry_age: 17
    duration_years: 2
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: Brevet de Technicien Supérieur (BTS)
    national_label_local: مؤهل التقني السامي
    entry_age: 19
    duration_years: 2
    isced_level: '4'
    ...
    source_row: 16
  - national_label_en: Licence fondamentale
    national_label_local: الإجازة الأساسية
    entry_age: 19
    duration_years: 3
    isced_level: '6'
    ...
    gmd_educat7_target: tertiary
    source_row: 17
  - national_label_en: Licence appliquée
    national_label_local: الإجازة التطبيقية
    entry_age: 19
    duration_years: 3
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 18
  - national_label_en: '"Baccalauréaus"'
    ...
    gmd_educat7_target: tertiary
    source_row: 19
  - national_label_en: Agrégation
    national_label_local: التبريز
    entry_age: 22
    duration_years: 1
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
  ...
  - national_label_en: Cycle préparatoire
    national_label_local: الحلقة التحضيرية
    entry_age: 19
    duration_years: 2
    isced_level: '7'
    ...
    gmd_educat7_target: tertiary
    source_row: 21
  - national_label_en: Diplôme national d'ingénieur
    national_label_local: الشهادة الوطنية في الهندسة
    entry_age: 21
    duration_years: 3
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 22
  - national_label_en: Doctorat en pharmacie
    national_label_local: الدكتوراه في الصيدلة
    entry_age: 19
    duration_years: 6
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 23
  - national_label_en: Architecture
    national_label_local: الهندسة المعمارية
    entry_age: 19
    duration_years: 6
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 24
  - national_label_en: Doctorat en médecine vétérinaire
    national_label_local: الدكتوراه في الطب البيطري
    entry_age: 20
    duration_years: 6
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 25
  - national_label_en: Doctorat en médecine
    national_label_local: الدكتوراه في الطب
    entry_age: 19
    duration_years: 7
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 26
  - national_label_en: Diplôme de spécialité
    national_label_local: شهادة اختصاص
    entry_age: 21
    duration_years: 3
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 27
  - national_label_en: Master de recherche
    national_label_local: ماجستير بحث
    entry_age: 22
    duration_years: 2
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 28
  - national_label_en: Master professionnelle
    national_label_local: ماجستير مهني
    entry_age: 22
    duration_years: 2
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 29
  - national_label_en: Diplôme national d'urbanisme et d'aménagement
    national_label_local: الشهادة الوطنية في التعمير والتهيأة
    entry_age: 22
    duration_years: 3
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 30
  - national_label_en: Cycle préparatoire pour accéder au programme de la révision
      comptable
    national_label_local: الحلقة التحضيرية للالتحاق ببرنامج المراجعة في المحاسبة
    entry_age: 22
    duration_years: 2
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 31
  - national_label_en: Révision comptable
    national_label_local: المراجعة في المحاسبة
    entry_age: 24
    duration_years: 1
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
...
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  selectors: ~
  value:
  - survey_labels: 1 - Grand Tunis
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: TUN_2015_GAUL1_3015
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    gmd_subnatidsurvey: TUN_2015_GAUL1_3015
    geo_year: '2015'
    geo_source: GAUL
    geo_level: '1'
    geo_idvar: ADM1_CODE
  ...
  - survey_labels: 2 - NE
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: TUN_2015_GAULx_2
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    is_rep_subnat4: no
    representative_level: 1
    gmd_subnatidsurvey: TUN_2015_GAULx_2
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
    geo_id: '2'
    geo_nvar: ADM1_NAME
    geo_name: Ariana & Ben Arous & Bizerte & Manouba & Nabeul & Zaghouan
    source_row: 16637
  - survey_labels: 3 - NW
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: TUN_2015_GAULx_3
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    is_rep_subnat4: no
    representative_level: 1
    gmd_subnatidsurvey: TUN_2015_GAULx_3
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
    geo_id: '3'
    geo_nvar: ADM1_NAME
    geo_name: Beja & Jendouba & Le Kef & Siliana
    source_row: 16638
  - survey_labels: 4 - CenterE
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: TUN_2015_GAULx_4
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    is_rep_subnat4: no
    representative_level: 1
    gmd_subnatidsurvey: TUN_2015_GAULx_4
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
    geo_id: '4'
    geo_nvar: ADM1_NAME
    geo_name: Mahdia & Monastir & Sfax & Sousse
    source_row: 16639
  - survey_labels: 5 - CenterW
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: TUN_2015_GAULx_5
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    is_rep_subnat4: no
    representative_level: 1
    gmd_subnatidsurvey: TUN_2015_GAULx_5
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
    geo_id: '5'
    geo_nvar: ADM1_NAME
    geo_name: Kairouan & Kasserine & Sidi Bouz
    source_row: 16640
  - survey_labels: 6 - SE
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: TUN_2015_GAULx_6
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    is_rep_subnat4: no
    representative_level: 1
    gmd_subnatidsurvey: TUN_2015_GAULx_6
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
    geo_id: '6'
    geo_nvar: ADM1_NAME
    geo_name: Gabes & Medenine & Tataouine
    source_row: 16641
  - survey_labels: 7 - SW
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: TUN_2015_GAULx_7
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    is_rep_subnat4: no
    representative_level: 1
    gmd_subnatidsurvey: TUN_2015_GAULx_7
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - source_category_code: chasse_reliee_a_autre_chose
    ...
    shared_flag: no
    source_row: 65
  - source_category_code: open_drain
    national_label_en: Open drain
    national_label_local: إلى مكان آخر
    jmp_classification: Flush and pour flush > to elsewhere
    jmp_id: flush_and_pour_flush.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - source_category_code: sewage_system
    national_label_en: Sewage system
    national_label_local: إلى نظام الصرف الصحي بالأنابيب
    jmp_classification: Flush and pour flush > to piped sewer system
    jmp_id: flush_and_pour_flush.to_piped_sewer_system
    gmd_target: flush_sewer
    ...
    shared_flag: no
    source_row: 61
  - source_category_code: toilettes_avec_chasse_d_eau_raccordement_reseau_assainissement
    national_label_en: 'toilettes avec chasse d''eau: raccordement reseau assainissement'
    national_label_local: إلى نظام الصرف الصحي بالأنابيب
    jmp_classification: Flush and pour flush > to piped sewer system
    jmp_id: flush_and_pour_flush.to_piped_sewer_system
    gmd_target: flush_sewer
  ...
  - source_category_code: chasse_d_eau_relie_a_fosse_sceptique
    ...
    shared_flag: no
    source_row: 62
  - source_category_code: covered_septic_tank
    national_label_en: Covered septic tank
    national_label_local: لخزان الصرف الصحي
    jmp_classification: Flush and pour flush > to septic tank
    jmp_id: flush_and_pour_flush.to_septic_tank
    gmd_target: flush_septic
  ...
  - source_category_code: chasse_d_eau_relie_a_lieu_inconnu
    ...
    shared_flag: no
    source_row: 64
  - source_category_code: chasse_reliee_a_endroit_inconnu_pas_sur_nsp
    national_label_en: |-
      Chasse reliée à endroit
      inconnu / Pas sûr / NSP
    national_label_local: إلى مكان غير معروف / لست متأكدًا / لا أعرف
    jmp_classification: Flush and pour flush > to unknown place/ not sure/DK
    jmp_id: flush_and_pour_flush.to_unknown_place_not_sure_dk
    ...
    shared_flag: no
    source_row: 64
  - source_category_code: toilettes_avec_chasse_d_eau_sans_raccordement_reseau_assainissement
    national_label_en: 'toilettes avec chasse d''eau: sans raccordement reseau assainissement'
    national_label_local: إلى مكان غير معروف / لست متأكدًا / لا أعرف
    jmp_classification: Flush and pour flush > to unknown place/ not sure/DK
    jmp_id: flush_and_pour_flush.to_unknown_place_not_sure_dk
    gmd_target: flush_elsewhere
  ...
  - source_category_code: private_flush_to_septic_tank
    ...
    shared_flag: no
    source_row: 74
  - source_category_code: shared_outdoor_wc
    national_label_en: Shared Outdoor WC
  ...
  - source_category_code: yes_and_connected_to_sewage
    ...
    shared_flag: no
    source_row: 67
  - source_category_code: chasse_d_eau_reliee_aux_latrines_puits_perdue
    national_label_en: 'CHASSE D’EAU: RELIEE AUX LATRINES/ PUITS PERDUE'
    national_label_local: للحفر
  ...
  - source_category_code: latrines_a_fosse_avec_dalle
    ...
    shared_flag: no
    source_row: 106
  - source_category_code: latrine_a_fosse_sans_dalle_fosse_ouverte_un_puits_perdue
    national_label_en: LATRINE A FOSSE SANS DALLE / FOSSE OUVERTE/ UN PUITS PERDUE
    ...
    shared_flag: no
    source_row: 108
  - source_category_code: latrine_a_fosse_sans_dalle_a_ciel_ouvert
    national_label_en: Latrine à fosse sans dalle/à ciel ouvert
    national_label_local: مرحاض حفرة بدون بلاطة / حفرة مفتوحة
    jmp_classification: Latrines > Dry latrines > Improved latrines > Pit latrine
      without slab/open pit
    jmp_id: latrines.dry_latrines.improved_latrines.pit_latrine_without_slab_open_pit
  ...
  - source_category_code: uncovered_dry_latrine_without_privacy
    ...
    shared_flag: no
    source_row: 108
  - source_category_code: toilettes_sans_chasse_d_eau
    national_label_en: toilettes sans chasse d'eau
  ...
  - source_category_code: toilettes_a_l_exterieur
    national_label_en: toilettes a l'exterieur
    national_label_local: المراحيض التقليدية
  ...
  - source_category_code: non_pas_disponible
    ...
    shared_flag: no
    source_row: 134
  - source_category_code: ouverte_un_puits_perdue
    national_label_en: OUVERTE/ UN PUITS PERDUE
    national_label_local: لا توجد منشأة ، شجيرة ، حقل
    jmp_classification: No facility, bush, field
    jmp_id: no_facility_bush_field
    gmd_target: open
  ...
  - source_category_code: pas_de_toilettes_nature_champs
    ...
    shared_flag: no
    source_row: 134
  - source_category_code: toilettes_communes
    national_label_en: toilettes communes
  ...
  - source_category_code: autre
    ...
    shared_flag: no
    source_row: 136
  - source_category_code: autre_preciser
    national_label_en: AUTRE (préciser)
    national_label_local: آخر
    jmp_classification: Other unimproved > Other
    jmp_id: other_unimproved.other
    gmd_target: other
  ...
  - source_category_code: other_unimproved_we_don_t_know_the_type_of_facilities
    ...
    shared_flag: no
    source_row: 136
  - source_category_code: toilet_other
    national_label_en: Toilet - other
    national_label_local: آخر
    jmp_classification: Other unimproved > Other
    jmp_id: other_unimproved.other
    gmd_target: other
  ...
  - source_category_code: toilettes_communes
    ...
    source_row: 137
  provenance:
    source: extraction\10_source\country-parameters-inputs\JMP\JMP_2025_TUN_Tunisia_0.xlsx
    verified_on: ~
    human_reviewed: no
    reviewer: ~
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - source_category_code: public_well
    ...
    shared_flag: yes
    source_row: 56
  - source_category_code: puits_public_non_equipe_moteur
    national_label_en: puits public non equipe moteur
    national_label_local: عام
    jmp_classification: Ground water > All wells > Public
    jmp_id: ground_water.all_wells.public
    gmd_target: ''
  ...
  - source_category_code: public_well
    ...
    shared_flag: yes
    source_row: 64
  - source_category_code: unequipped_public_well
    national_label_en: Unequipped public well
    national_label_local: عام
    jmp_classification: Ground water > Traditional wells > Public
    jmp_id: ground_water.traditional_wells.public
    gmd_target: ''
  ...
  - source_category_code: drilled_well
    national_label_en: Drilled Well
  ...
  - source_category_code: source_source_non_protegee
    ...
    shared_flag: no
    source_row: 82
  - source_category_code: unequipped_spring
    national_label_en: Unequipped spring
    national_label_local: ينبوع غير المحمي
    jmp_classification: Ground water > Unprotected spring
    jmp_id: ground_water.unprotected_spring
    gmd_target: unprotected_spring
  ...
  - source_category_code: charrette_avec_petite_citerne_tonneau
    ...
    shared_flag: no
    source_row: 101
  - source_category_code: citerne_privee
    national_label_en: citerne privee
    national_label_local: عربة مع خزان صغير / أسطوانة
    jmp_classification: Other improved sources > Cart with small tank/drum
    jmp_id: other_improved_sources.cart_with_small_tank_drum
    gmd_target: tanker
  ...
  - source_category_code: citerne_privee
    ...
    shared_flag: no
    source_row: 103
  - source_category_code: eau_osmosee_par_des_unites_privees_non_controlees
    national_label_en: EAU OSMOSEE PAR DES UNITES PRIVEES NON CONTROLEES
    national_label_local: آخر
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other
    gmd_target: other
    ...
    shared_flag: no
    source_row: 103
  - source_category_code: fontaine_ong
    national_label_en: fontaine ONG
    national_label_local: آخر
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other
    gmd_target: other
    ...
    shared_flag: no
    source_row: 103
  - source_category_code: private_tanker
    national_label_en: Private tanker
    national_label_local: آخر
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other
    gmd_target: other
    ...
    shared_flag: no
    source_row: 103
  - source_category_code: public_private_tank
    national_label_en: Public/Private Tank
    national_label_local: آخر
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other
    gmd_target: other
    ...
    shared_flag: no
    source_row: 103
  - source_category_code: tap_spring_or_well_water_provided_under_a_cooperative_control
    national_label_en: Tap, spring or well water provided under a cooperative control
    national_label_local: آخر
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other
    gmd_target: other
    ...
    shared_flag: no
    source_row: 103
  - source_category_code: citerne_publique
    national_label_en: citerne publique
    national_label_local: آخر
    jmp_classification: Other improved sources > Other
    ...
    shared_flag: no
    source_row: 104
  - source_category_code: water_tap_spring_or_well_at_the_disposal_of_water_association
    national_label_en: Water tap, spring or well at the disposal of water association
    national_label_local: آخر
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other#2
    gmd_target: other
  ...
  - source_category_code: citerne_publique
    ...
    shared_flag: no
    source_row: 102
  - source_category_code: public_tanker
    national_label_en: Public tanker
    national_label_local: يتم توفير شاحنة صهريج
    jmp_classification: Other improved sources > Tanker truck provided
    jmp_id: other_improved_sources.tanker_truck_provided
    gmd_target: tanker
  ...
  - source_category_code: other
    ...
    shared_flag: no
    source_row: 106
  - source_category_code: source_non_controlee
    national_label_en: source non controlee
    national_label_local: آخر
    jmp_classification: Other non-improved > Other
    jmp_id: other_non_improved.other
    gmd_target: other
  ...
  - source_category_code: eau_en_bouteille
    ...
    shared_flag: no
    source_row: 90
  - source_category_code: eau_en_bouteille_avec_source_ameliorees
    national_label_en: Eau en bouteille avec source améliorées
    national_label_local: مياه معبأة
    jmp_classification: Packaged water > Bottled water
    jmp_id: packaged_water.bottled_water
    gmd_target: bottled
  ...
  - source_category_code: eau_de_pluie
    ...
    shared_flag: no
    source_row: 87
  - source_category_code: eau_de_pluie_majel_fetsquia
    national_label_en: |-
      Eau de pluie/
      Majel/ Fetsquia
    national_label_local: خزان / خزان مغطى
  ...
  - source_category_code: fontaine_ong
    ...
    shared_flag: no
    source_row: 42
  - source_category_code: public_fountain_public_tap_connected_to_utility_network
    national_label_en: Public fountain + Public tap connected to utility network
    national_label_local: آخر
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
  ...
  - source_category_code: robinet_chez_le_voisin
    ...
    shared_flag: no
    source_row: 42
  - source_category_code: sonede_sans_facture
    national_label_en: SONEDE sans facture
    national_label_local: آخر
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
  ...
  - source_category_code: public_network
    ...
    shared_flag: no
    source_row: 38
  - source_category_code: sonede
    national_label_en: SONEDE
    national_label_local: اتصالات المنزل
    jmp_classification: Tap water > Piped on premises
    jmp_id: tap_water.piped_on_premises
    gmd_target: piped
  ...
  - source_category_code: robinet_dans_le_logement
    ...
    shared_flag: no
    source_row: 39
  - source_category_code: sonede_avec_facture
    national_label_en: SONEDE avec facture
    national_label_local: الماء بالأنابيب في المسكن
    jmp_classification: Tap water > Piped on premises > Piped water into dwelling
    jmp_id: tap_water.piped_on_premises.piped_water_into_dwelling
    gmd_target: piped
    ...
    shared_flag: no
    source_row: 39
  - source_category_code: tap_water_inside_the_dwelling_with_bill
    national_label_en: Tap water inside the dwelling (with bill)
    national_label_local: الماء بالأنابيب في المسكن
    jmp_classification: Tap water > Piped on premises > Piped water into dwelling
    jmp_id: tap_water.piped_on_premises.piped_water_into_dwelling
    gmd_target: piped
  ...
  - source_category_code: robinet_dans_la_concession_jardin_parcelle
    ...
    shared_flag: no
    source_row: 40
  - source_category_code: tap_water_outside_the_dwelling_without_bill
    national_label_en: Tap water outside the dwelling  (without bill)
    national_label_local: المياه المنقولة بالأنابيب إلى ساحة / قطعة أرض
    jmp_classification: Tap water > Piped on premises > Piped water to yard/plot
    jmp_id: tap_water.piped_on_premises.piped_water_to_yard_plot
    gmd_target: piped
    ...
    shared_flag: no
    source_row: 40
  - source_category_code: fontaine_publique_liee_sonede
    national_label_en: Fontaine publique liee SONEDE
  ...
  - source_category_code: standpipe
    ...
    shared_flag: no
    source_row: 41
  - source_category_code: water_reservoir_fountain
    national_label_en: Water reservoir/fountain
    national_label_local: الحنفية العامة والصنبور الرأسي
    jmp_classification: Tap water > Public tap, standpipe
    jmp_id: tap_water.public_tap_standpipe
    gmd_target: piped
