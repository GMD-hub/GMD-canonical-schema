...
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  - survey_labels: 1 - Punjab | 1-Punjab
    ...
    gmd_subnatid1: PAK_2015_GAULx_1
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '1'
    geo_nvar: ADM1_NAME
    geo_name: Punjab & Islamabad
    source_row: 10964
  - survey_labels: 2 - Sindh | 2-Sindh
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: PAK_2015_GAUL1_2277
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_name: Sindh
    source_row: 10965
  - survey_labels: 3 - Khyber Pakhtunkhwa | 3-Khyber Pakhtunkhwa
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: PAK_2015_GAULx_3
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '3'
    geo_nvar: ADM1_NAME
    geo_name: North-West Frontier & Federally Administered Tribal Areas
    source_row: 10966
  - survey_labels: 4 - Balochistan | 4-Balochistan
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: PAK_2015_GAUL1_2272
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - source_category_code: flush_connected_open_drain
    national_label_en: flush connected open drain
    national_label_local: to elsewhere
    jmp_classification: Flush and pour flush > to elsewhere
    jmp_id: flush_and_pour_flush.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - source_category_code: flush_connected_to_open_drain
    national_label_en: flush connected to open drain
    national_label_local: to elsewhere
    jmp_classification: Flush and pour flush > to elsewhere
    jmp_id: flush_and_pour_flush.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - source_category_code: flush_connected_to_open_drains
    national_label_en: flush connected to open drains
    national_label_local: to elsewhere
    jmp_classification: Flush and pour flush > to elsewhere
    jmp_id: flush_and_pour_flush.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - source_category_code: flush_to_somewhere_esse
    national_label_en: Flush to somewhere esse
    national_label_local: to elsewhere
    jmp_classification: Flush and pour flush > to elsewhere
    jmp_id: flush_and_pour_flush.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - source_category_code: flush_connected_to_public_sewerage
    national_label_en: flush connected to public sewerage
    national_label_local: to piped sewer system
    jmp_classification: Flush and pour flush > to piped sewer system
    jmp_id: flush_and_pour_flush.to_piped_sewer_system
    gmd_target: flush_sewer
  ...
  - source_category_code: flush_connected_to_sewerage
    national_label_en: flush connected to sewerage
    national_label_local: to piped sewer system
    jmp_classification: Flush and pour flush > to piped sewer system
    jmp_id: flush_and_pour_flush.to_piped_sewer_system
    gmd_target: flush_sewer
  ...
  - source_category_code: flush_to_sewerage
    national_label_en: Flush to sewerage
    national_label_local: to piped sewer system
    jmp_classification: Flush and pour flush > to piped sewer system
    jmp_id: flush_and_pour_flush.to_piped_sewer_system
    gmd_target: flush_sewer
  ...
  - source_category_code: flush_connected_to_pit
    national_label_en: flush connected to pit
    national_label_local: to pit
    jmp_classification: Flush and pour flush > to pit
    jmp_id: flush_and_pour_flush.to_pit
    gmd_target: flush_pit
  ...
  - source_category_code: flush_connected_to_septic_tank
    national_label_en: flush connected to septic tank
    national_label_local: to septic tank
    jmp_classification: Flush and pour flush > to septic tank
    jmp_id: flush_and_pour_flush.to_septic_tank
    gmd_target: flush_septic
  ...
  - source_category_code: dry_raised_latrine
    national_label_en: Dry raised latrine
  ...
  - source_category_code: dry_pit_latrine
    national_label_en: Dry pit latrine
  ...
  - source_category_code: field_open_spaces
    national_label_en: field/open spaces
  ...
  - source_category_code: no_toilet_fields_open_place
    national_label_en: No toilet/fields/open place
    national_label_local: No facility, bush, field
    jmp_classification: No facility, bush, field
    jmp_id: no_facility_bush_field
    gmd_target: open
...
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - source_category_code: protected_spring_inside_and_outside_dwelling
    national_label_en: Protected spring (inside and outside dwelling)
    national_label_local: Protected spring
    jmp_classification: Ground water > Protected spring
    jmp_id: ground_water.protected_spring
    gmd_target: protected_spring
  ...
  - source_category_code: protected_spring_karez
    national_label_en: Protected spring/karez
    national_label_local: Protected spring
    jmp_classification: Ground water > Protected spring
    jmp_id: ground_water.protected_spring
    gmd_target: protected_spring
  ...
  - source_category_code: closed_well_inside_and_outside_dwelling
    national_label_en: Closed well (inside and outside dwelling)
    national_label_local: Protected well
    jmp_classification: Ground water > Protected well
    jmp_id: ground_water.protected_well
    gmd_target: protected_well
  ...
  - source_category_code: well_without_hand_pump
    national_label_en: Well without hand pump
    national_label_local: Traditional wells
    jmp_classification: Ground water > Traditional wells
    jmp_id: ground_water.traditional_wells
    gmd_target: ''
  ...
  - source_category_code: hand_pump_motor_pump
    national_label_en: '"hand pump" + "motor pump"'
  ...
  - source_category_code: hand_pump_water_motor
    national_label_en: '"Hand pump"+"Water motor"'
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - source_category_code: motor_pump_tubewell_inside_and_outside_dwelling
    national_label_en: Motor pump, tubewell (inside and outside dwelling)
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - source_category_code: motorised_pump
    national_label_en: Motorised pump
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - source_category_code: motorized_pumping_tubewell
    national_label_en: motorized pumping/tubewell
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - source_category_code: tube_well_or_borehole_hand_pump
    national_label_en: Tube well or borehole & Hand pump
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - source_category_code: tube_well_or_borehole_or_suction_pump
    national_label_en: Tube well or borehole or suction pump
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - source_category_code: tube_well_motorized_pump
    national_label_en: tube well/motorized pump
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - source_category_code: well_with_handpump_tubewell
    national_label_en: Well with Handpump, tubewell
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - source_category_code: unprotected_spring_inside_and_outside_dwelling
    national_label_en: Unprotected spring (inside and outside dwelling)
    national_label_local: Unprotected spring
    jmp_classification: Ground water > Unprotected spring
    jmp_id: ground_water.unprotected_spring
    gmd_target: unprotected_spring
  ...
  - source_category_code: open_well_inside_and_outside_dwelling
    national_label_en: Open well (inside and outside dwelling)
    national_label_local: Unprotected well
    jmp_classification: Ground water > Unprotected well
    jmp_id: ground_water.unprotected_well
    gmd_target: unprotected_well
  ...
  - source_category_code: filtration_plant
    national_label_en: filtration plant
    national_label_local: Other
  ...
  - source_category_code: hand_pump_inside_and_outside_dwelling
    national_label_en: Hand pump (inside and outside dwelling)
    national_label_local: Other
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other
    gmd_target: other
  ...
  - source_category_code: hand_pump_mechanical
    national_label_en: Hand pump (mechanical)
    national_label_local: Other
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other
    gmd_target: other
  ...
  - source_category_code: tanker_truck_water_bearer
    national_label_en: tanker /truck/water bearer
  ...
  - source_category_code: tanker_truck_water_fetcher
    national_label_en: Tanker truck, water fetcher
    national_label_local: Tanker truck provided
    jmp_classification: Other improved sources > Tanker truck provided
    jmp_id: other_improved_sources.tanker_truck_provided
    gmd_target: tanker
  ...
  - source_category_code: tanker_truck_or_vendor
    national_label_en: tanker/truck or vendor
    national_label_local: Tanker truck provided
    jmp_classification: Other improved sources > Tanker truck provided
    jmp_id: other_improved_sources.tanker_truck_provided
    gmd_target: tanker
  ...
  - source_category_code: tanker_trucks_or_vendor
    national_label_en: tanker/trucks or vendor
    national_label_local: Tanker truck provided
    jmp_classification: Other improved sources > Tanker truck provided
    jmp_id: other_improved_sources.tanker_truck_provided
    gmd_target: tanker
  ...
  - source_category_code: tanker_water_barier
    national_label_en: tanker/water barier
    national_label_local: Tanker truck provided
    jmp_classification: Other improved sources > Tanker truck provided
    jmp_id: other_improved_sources.tanker_truck_provided
    gmd_target: tanker
  ...
  - source_category_code: pond_canal_river
    national_label_en: Pond, canal, river
  ...
  - source_category_code: pound_canal_river_stream
    national_label_en: pound/canal/river/stream
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - source_category_code: river_pond_stream_spring
    national_label_en: river pond stream(spring)
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - source_category_code: river_canal_karez
    national_label_en: River, canal, karez
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - source_category_code: river_stream_pond_etc
    national_label_en: River, stream, pond etc
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - source_category_code: river_pond_canal_stream
    national_label_en: River/pond/canal/stream
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - source_category_code: river_stream_pond_canal
    national_label_en: river/stream/pond/canal
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - source_category_code: piped_onto_property
    national_label_en: Piped onto property
    national_label_local: Other
  ...
  - source_category_code: tap_in_home_courtyard
    national_label_en: Tap (in home, courtyard)
    national_label_local: Piped on premises
    jmp_classification: Tap water > Piped on premises
    jmp_id: tap_water.piped_on_premises
    gmd_target: piped
  ...
  - source_category_code: pipe_into_residence
    national_label_en: Pipe into residence
  ...
  - source_category_code: piped_into_house_compound
    national_label_en: piped into house/compound
    national_label_local: Piped water into dwelling
    jmp_classification: Tap water > Piped on premises > Piped water into dwelling
    jmp_id: tap_water.piped_on_premises.piped_water_into_dwelling
    gmd_target: piped
  ...
  - source_category_code: piped_water_inside_compound
    national_label_en: piped water (inside compound)
    national_label_local: Piped water to yard/plot
    jmp_classification: Tap water > Piped on premises > Piped water to yard/plot
    jmp_id: tap_water.piped_on_premises.piped_water_to_yard_plot
    gmd_target: piped
  ...
  - source_category_code: piped_water_outside_dwelling
    national_label_en: Piped water outside dwelling
    national_label_local: Piped water to yard/plot
    jmp_classification: Tap water > Piped on premises > Piped water to yard/plot
    jmp_id: tap_water.piped_on_premises.piped_water_to_yard_plot
    gmd_target: piped
  ...
  - source_category_code: piped_water_piped_to_compound_yard_plot
    national_label_en: 'piped water: piped to compound/yard / plot'
    national_label_local: Piped water to yard/plot
    jmp_classification: Tap water > Piped on premises > Piped water to yard/plot
    jmp_id: tap_water.piped_on_premises.piped_water_to_yard_plot
    gmd_target: piped
  ...
  - source_category_code: out_door_tap
    national_label_en: out door tap
  ...
  - source_category_code: tap_outside_the_home
    national_label_en: Tap (outside the home)
    national_label_local: Public tap, standpipe
    jmp_classification: Tap water > Public tap, standpipe
    jmp_id: tap_water.public_tap_standpipe
    gmd_target: piped
