...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  selectors: ~
  value:
  - national_label_en: Pre-primary/ Kindergarten
    national_label_local: Kleuternonderwijs
    entry_age: 4
    duration_years: 2
    isced_level: '0'
  ...
  - national_label_en: Primary
    national_label_local: GLO (Gewoon lager onderwijs)
    entry_age: 6
    duration_years: 6
    isced_level: '1'
  ...
  - national_label_en: Special education
    ...
    gmd_educat7_target: primary_complete
    source_row: 9
  - national_label_en: Junior secondary education General
    national_label_local: MULO (Meer Uitgebreid Lagen Onderwijs)
    entry_age: 12
    duration_years: 4
    isced_level: '2'
    ...
    source_row: 10
  - national_label_en: Continuing special education vocational
    national_label_local: VSO (Voortgezet speciaal onderwijs)
    entry_age: 12
    duration_years: 4
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    source_row: 11
  - national_label_en: Lower home economics
    national_label_local: LHNO (Lager huishoud en nijverheidsonderwijs)
    entry_age: 12
    duration_years: 2
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    gmd_educat7_target: lower_secondary_incomplete
    source_row: 12
  - national_label_en: Junior elementary technical school
    national_label_local: ETS (Eenvoudig Technisch Onderwijs)
    entry_age: 12
    duration_years: 3
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    gmd_educat7_target: lower_secondary_complete
    source_row: 13
  - national_label_en: Lower technical education
    national_label_local: LTO (Lager technische school)
    entry_age: 12
    duration_years: 4
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    gmd_educat7_target: lower_secondary_complete
    source_row: 14
  - national_label_en: Lower vocational education
    national_label_local: LBGO (Lager beroepsgericht onderwijs)
    entry_age: 12
    duration_years: 4
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    gmd_educat7_target: lower_secondary_complete
    source_row: 15
  - national_label_en: Lower vocational education - A
    national_label_local: LBO - A (Lager beroeps onderwijs - A)
    entry_age: 12
    duration_years: 4
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    gmd_educat7_target: lower_secondary_complete
    source_row: 16
  - national_label_en: Lower vocational education - B
    national_label_local: LBO - B (Lager beroeps onderwijs - B)
    entry_age: 12
    duration_years: 4
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    gmd_educat7_target: lower_secondary_complete
    source_row: 17
  - national_label_en: Lower vocational education - C
    national_label_local: LBO - C (Lager beroeps onderwijs - C)
    entry_age: 12
    duration_years: 4
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    gmd_educat7_target: lower_secondary_complete
    source_row: 18
  - national_label_en: Preparatory Scientific Education (Secondary General education)
    national_label_local: VWO (Voortgezet wetenschappelijk onderwijs)
    entry_age: 16
    duration_years: 3
    isced_level: '3'
    ...
    source_row: 19
  - national_label_en: Higher General Education (Secondary General education)
    national_label_local: HAVO (Hoger algemeen vormend onderwijs)
    entry_age: 16
    duration_years: 3
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 20
  - national_label_en: Institute for Economic and Administrative Secondary  Education
      (Commercial College)
    national_label_local: IMEAO (Instituut voor middelbaar economisch administratief
      onderwijs)
    entry_age: 16
    duration_years: 3
    isced_level: '3'
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 21
  - national_label_en: Institute for Natural Resources and Engineering Studies (Secondary
      Vocational education)
    national_label_local: NATIN (Natuur technisch instituut)
    entry_age: 16
    duration_years: 3
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: Teacher training
    national_label_local: HOOFD AKTE
    entry_age: 16
    duration_years: 3
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 23
  - national_label_en: Preparatory studies before entering university
    national_label_local: Schakeljaar universiteit
    entry_age: 19
    duration_years: 2
    isced_level: '4'
    ...
    source_row: 24
  - national_label_en: Teacher Training for Vocational Education
    national_label_local: LOBO (Leraren opleiding beroepsonderwijs)
    entry_age: 19
    duration_years: 3
    isced_level: '5'
    ...
    gmd_educat7_target: tertiary
    source_row: 25
  - national_label_en: Infrastructure, Construction, Agriculture, ICT (PTC - Polytechnic
      College)
    national_label_local: PTC (Polytechnic College Suriname)
    entry_age: 19
    duration_years: 4
    isced_level: '6'
    ...
    gmd_educat7_target: tertiary
    source_row: 26
  - national_label_en: Journalism, Arts and culture, Social studies (Academy for Higher
      Arts and Cultural Studies)
    national_label_local: AHKCO (Academie voor hoger kunst- en cultuuronderwijs)
    entry_age: 19
    duration_years: 4
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 27
  - national_label_en: Advanced Teacher Training Institute
    national_label_local: IOL (Instituut voor de Opleiding van Leraren)
    entry_age: 19
    duration_years: 6
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 28
  - national_label_en: Social sciences, Medical sciences, Technical sciences (University
      of Suriname)
    national_label_local: 'Anton de kom Universiteit van Suriname (Adek): Faculteit
      Maatschappij -, Medische -, Technologische Wetenschappen'
    entry_age: 19
    duration_years: 5
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
  ...
  - national_label_en: Social sciences, Medical sciences, Technical sciences (University
    ...
    source_row: 30
  provenance:
    source: extraction\10_source\country-parameters-inputs\ISCED\ISCED_2011_Mapping_Suriname.xlsx
    verified_on: ~
    human_reviewed: no
    reviewer: ~
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  selectors: ~
  value:
  - survey_labels: 1- Great Paramaribo
    survey_variables: subnatid
    gmd_subnatid1: SUR_2016_NSO1_1
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    gmd_subnatidsurvey: SUR_2016_NSO1_1
    geo_year: '2016'
    geo_source: NSO
    geo_level: '1'
    geo_idvar: d_code
    geo_id: '1'
    geo_nvar: domain
    geo_name: Great Paramaribo
    source_row: 15032
  - survey_labels: 2- Rest of coastal region
    survey_variables: subnatid
    gmd_subnatid1: SUR_2016_NSO1_2
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    is_rep_subnat4: no
    representative_level: 1
    gmd_subnatidsurvey: SUR_2016_NSO1_2
    geo_year: '2016'
    geo_source: NSO
    geo_level: '1'
    geo_idvar: d_code
    geo_id: '2'
    geo_nvar: domain
    geo_name: Rest of coastal region
    source_row: 15033
  - survey_labels: 3- Interior
    survey_variables: subnatid
    gmd_subnatid1: SUR_2016_NSO1_3
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    is_rep_subnat4: no
    representative_level: 1
    gmd_subnatidsurvey: SUR_2016_NSO1_3
    geo_year: '2016'
    geo_source: NSO
    geo_level: '1'
    geo_idvar: d_code
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - source_category_code: flush_pour_flush_to_open_drain
    ...
    shared_flag: no
    source_row: 65
  - source_category_code: river_or_creek
    national_label_en: River or creek
    national_label_local: to elsewhere
    jmp_classification: Flush and pour flush > to elsewhere
    jmp_id: flush_and_pour_flush.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - source_category_code: flush_pour_flush_to_septic_tank
    ...
    shared_flag: no
    source_row: 62
  - source_category_code: wc_with_flushing_linked_to_septic_tank
    national_label_en: WC with flushing (linked to septic tank)
    national_label_local: to septic tank
    jmp_classification: Flush and pour flush > to septic tank
    jmp_id: flush_and_pour_flush.to_septic_tank
    gmd_target: flush_septic
  ...
  - source_category_code: flush_pour_flush_to_dk_where
    ...
    shared_flag: no
    source_row: 64
  - source_category_code: wc_not_linked_to_septic_tank
    national_label_en: WC not linked to septic tank
    national_label_local: to unknown place/ not sure/DK
    jmp_classification: Flush and pour flush > to unknown place/ not sure/DK
    jmp_id: flush_and_pour_flush.to_unknown_place_not_sure_dk
    gmd_target: flush_elsewhere
  ...
  - source_category_code: open_pit
    ...
    shared_flag: no
    source_row: 108
  - source_category_code: open_well_or_hole_in_the_ground
    national_label_en: Open well or hole in the ground
    national_label_local: Pit latrine without slab/open pit
    jmp_classification: Latrines > Dry latrines > Improved latrines > Pit latrine
      without slab/open pit
    jmp_id: latrines.dry_latrines.improved_latrines.pit_latrine_without_slab_open_pit
  ...
  - source_category_code: no_facilities_or_bush_or_field
    ...
    shared_flag: no
    source_row: 134
  - source_category_code: no_facilities_bush_field_river
    national_label_en: No facilities/ bush/ field /River
    national_label_local: No facility, bush, field
    jmp_classification: No facility, bush, field
    jmp_id: no_facility_bush_field
    gmd_target: open
  ...
  - source_category_code: other
    ...
    source_row: 136
  provenance:
    source: extraction\10_source\country-parameters-inputs\JMP\JMP_2025_SUR_Suriname_1.xlsx
    verified_on: ~
    human_reviewed: no
    reviewer: ~
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - source_category_code: bw_with_other_improved
    ...
    shared_flag: no
    source_row: 90
  - source_category_code: bottled_water_minus_improved
    national_label_en: Bottled water minus improved
  ...
  - source_category_code: public_piped_into_yard
    ...
    shared_flag: no
    source_row: 40
  - source_category_code: key_public_tap
    national_label_en: Key / Public tap
