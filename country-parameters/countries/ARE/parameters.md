...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - national_label_en: First cycle of basic education
    national_label_local: الحلقة الأولى من التعليم الأساسي
    entry_age: 6
    duration_years: 4
    isced_level: '1'
    ...
    source_row: 9
  - national_label_en: First cycle of basic education-Adult education programmes
    national_label_local: الحلقة الأولى من التعليم الأساسي - برامج تعليم الكبار
    entry_age: 9
    duration_years: 4
    isced_level: '1'
    isced_label: ISCED 1 Primary
  ...
  - national_label_en: Second cycle  of basic education
    national_label_local: الحلقة الثانية من التعليم الأساسي
    entry_age: 10
    duration_years: 4
    isced_level: '2'
    ...
    source_row: 11
  - national_label_en: Second cycle  of basic education-Adult education programmes
    national_label_local: الحلقة الثانية من التعليم الأساسي - برامج تعليم الكبار
    entry_age: 15
    duration_years: 3
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    gmd_educat7_target: lower_secondary_complete
    source_row: 12
  - national_label_en: General secondary cycle
    national_label_local: الحلقة الثانوية العامة
    entry_age: 14
    duration_years: 4
    isced_level: '3'
    ...
    source_row: 13
  - national_label_en: General secondary cycle-Adult education programmes
    national_label_local: المرحلة الثانوية العامة- برامج تعليم الكبار
    entry_age: 18
    duration_years: 3
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 14
  - national_label_en: Second cycle of vocational secondary
    national_label_local: الحلقة الثانية من الثانوية المهنية
    entry_age: 14
    duration_years: 4
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 15
  - national_label_en: Injaz program
    national_label_local: برنامج انجاز
    entry_age: 18
    duration_years: 1
    isced_level: '4'
    ...
    source_row: 16
  - national_label_en: Diploma programs
  ...
  - national_label_en: Bachelor's programme
    national_label_local: برنامج البكالوريوس
    entry_age: 18
    duration_years: 4
    isced_level: '6'
    ...
    gmd_educat7_target: tertiary
    source_row: 19
  - national_label_en: Bachelor's programmes - 4 years (pharmacy, architecture)
    national_label_local: برامج البكالوريوس-4 سنوات (الصيدلة ،الهندسة المعمارية)
    entry_age: 18
    duration_years: 4
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 20
  - national_label_en: Vocational  teaching programme
    national_label_local: البرنامج المهني في التعليم
    entry_age: 22
    duration_years: 1
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 21
  - national_label_en: Higher education programmes
    national_label_local: برامج الدراسات العليا
    entry_age: 22
    duration_years: 2
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 22
  - national_label_en: Bachelor's programmes -6 years (medicine, dentistry)
    national_label_local: برامج البكالوريوس -6 سنوات (الطب، طب أسنان)
    entry_age: 18
    duration_years: 6
    isced_level: '7'
    ...
    gmd_educat7_target: tertiary
    source_row: 23
  - national_label_en: Executive master in business administration programmes (EMBA)
    national_label_local: برامج الماجستير التنفيذي في إدارة الأعمال
    entry_age: 22
    duration_years: 2
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
  ...
  - national_label_en: Doctoral  programmes
    ...
    source_row: 26
  provenance:
    source: extraction\10_source\country-parameters-inputs\ISCED\ISCED_2011_Mapping_United_Arab_Emirates.xlsx
    verified_on: ~
    human_reviewed: no
    reviewer: ~
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  selectors: ~
  value:
  - source_category_code: to_somewhere_else
    national_label_en: to somewhere else
  ...
  - source_category_code: pit_latrine_with_slab_covered_latrine
    ...
    shared_flag: no
    source_row: 106
  - source_category_code: uncovered_dry_latrine_without_provacy
    national_label_en: Uncovered dry latrine (without provacy)
  ...
  - source_category_code: pour_flush_latrine
    ...
    source_row: 85
  provenance:
    source: extraction\10_source\country-parameters-inputs\JMP\JMP_2025_ARE_United_Arab_Emirates_1.xlsx
    verified_on: ~
    human_reviewed: no
    reviewer: ~
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - source_category_code: cart_with_small_tank_drum
    ...
    shared_flag: no
    source_row: 101
  - source_category_code: filter_purifier
    national_label_en: Filter/purifier
