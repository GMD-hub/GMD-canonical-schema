...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - country_entry_id: BGD-EDU-01
    ...
    national_label_local: Prak-Prathomik Shikkha
    entry_age: 3
    duration_years: 3
    isced_level: '0'
  ...
  - country_entry_id: BGD-EDU-18
    ...
    national_label_local: 'Diploma in: Textiles, Health Technology, Surveying, Ceramics,
      Nursing, Graphic Arts'
    entry_age: 16
    duration_years: 4
    isced_level: '4'
  ...
  - country_entry_id: BGD-EDU-24
    ...
    national_label_local: 'Snatok (Sanman): Social Science, Science, Humanities, Business
      studies/Commerce , Education;  Engineering, Agriculture, etc.'
    entry_age: 18
    duration_years: 4
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
  ...
  - country_entry_id: BGD-EDU-29
    national_label_en: Bachelor of Medicine & Surgery (MBBS), Bachelor of Dental Surgery
      (BDS)
    national_label_local: MBBS (Bachelor of Medicine & Bachelor of Surgery), BDS (Bachelor
      of Dental Surgery)
    entry_age: 18
    duration_years: 5
    isced_level: '7'
  ...
  - country_entry_id: BGD-EDU-34
    national_label_en: Post Graduate Diploma (PGD) in Health, M.Phil Degree, and M.S.
      Degree
    national_label_local: Post Graduate Diploma (PGD) in Health, M.Phil Degree
    entry_age: 23
    duration_years: 2
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
...
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  - country_entry_id: BGD-SUBNAT-01
    ...
    gmd_subnatid1: BGD_2015_GAUL1_575
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_name: Barisal
    source_row: 787
  - country_entry_id: BGD-SUBNAT-02
    survey_labels: 20 - Chittagong | 20-Chittagong | Chittagong
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: BGD_2015_GAUL1_576
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_name: Chittagong
    source_row: 788
  - country_entry_id: BGD-SUBNAT-03
    survey_labels: 30 - Dhaka | 30-Dhaka | Dhaka
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: BGD_2015_GAUL1_577
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_name: Dhaka
    source_row: 789
  - country_entry_id: BGD-SUBNAT-04
    survey_labels: 40 - Khulna | Khulna
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: BGD_2015_GAUL1_578
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_name: Khulna
    source_row: 790
  - country_entry_id: BGD-SUBNAT-05
    survey_labels: 50 - Rajshahi | 50-Rajshahi | Rajshahi
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: BGD_2015_GAUL1_61362
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_name: Rajshahi
    source_row: 791
  - country_entry_id: BGD-SUBNAT-06
    survey_labels: 55 - Rangpur | 55-Rangpur | Rangpur
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: BGD_2015_GAUL1_61363
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_name: Rangpur
    source_row: 792
  - country_entry_id: BGD-SUBNAT-07
    survey_labels: 60 - Sylhet | 60-Sylhet | Sylhet
    survey_variables: subnatid | subnatid1
    gmd_subnatid1: BGD_2015_GAUL1_580
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - country_entry_id: BGD-SAN-01
    ...
    national_label_en: Compositing toilet
  ...
  - country_entry_id: BGD-SAN-03
    ...
    national_label_en: Composting latrines
  ...
  - country_entry_id: BGD-SAN-04
    ...
    national_label_en: Flash to open drainage
  ...
  - country_entry_id: BGD-SAN-05
    ...
    national_label_en: Flush latrine connected to open drain
    national_label_local: to elsewhere
    jmp_classification: Flush and pour flush > to elsewhere
    jmp_id: flush_and_pour_flush.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - country_entry_id: BGD-SAN-08
    ...
    national_label_en: Flash to sewerage system
  ...
  - country_entry_id: BGD-SAN-11
    ...
    national_label_en: Sewer connection
    national_label_local: to piped sewer system
    jmp_classification: Flush and pour flush > to piped sewer system
    jmp_id: flush_and_pour_flush.to_piped_sewer_system
    gmd_target: flush_sewer
  ...
  - country_entry_id: BGD-SAN-12
    ...
    national_label_en: Flash to protected pit
  ...
  - country_entry_id: BGD-SAN-14
    ...
    national_label_en: Falsh to safety tank
  ...
  - country_entry_id: BGD-SAN-15
    ...
    national_label_en: Flash to safety tank
    national_label_local: to septic tank
    jmp_classification: Flush and pour flush > to septic tank
    jmp_id: flush_and_pour_flush.to_septic_tank
    gmd_target: flush_septic
  ...
  - country_entry_id: BGD-SAN-18
    ...
    national_label_en: Flash to unidentified area
  ...
  - country_entry_id: BGD-SAN-20
    ...
    national_label_en: Flush to unknown place/not sure/don't know
    national_label_local: to unknown place/ not sure/DK
    jmp_classification: Flush and pour flush > to unknown place/ not sure/DK
    jmp_id: flush_and_pour_flush.to_unknown_place_not_sure_dk
    gmd_target: flush_elsewhere
  ...
  - country_entry_id: BGD-SAN-31
    ...
    national_label_en: Septic Tank, modern
    national_label_local: to septic tank
    jmp_classification: Flush/toilets > to septic tank
    jmp_id: flush_toilets.to_septic_tank
    gmd_target: flush_septic
  ...
  - country_entry_id: BGD-SAN-32
    ...
    national_label_en: Septic tank, modern toilet
    national_label_local: to septic tank
    jmp_classification: Flush/toilets > to septic tank
    jmp_id: flush_toilets.to_septic_tank
    gmd_target: flush_septic
  ...
  - country_entry_id: BGD-SAN-38
    ...
    national_label_en: Bucket or Tub or bucket latrine
    national_label_local: Bucket latrine
    jmp_classification: Latrines > Dry latrines > Improved latrines > Bucket latrine
    jmp_id: latrines.dry_latrines.improved_latrines.bucket_latrine
    gmd_target: bucket
  ...
  - country_entry_id: BGD-SAN-46
    ...
    national_label_en: Open or hanging latrine
    national_label_local: Hanging toilet/hanging latrine
    jmp_classification: Latrines > Dry latrines > Improved latrines > Hanging toilet/hanging
      latrine
    jmp_id: latrines.dry_latrines.improved_latrines.hanging_toilet_hanging_latrine
  ...
  - country_entry_id: BGD-SAN-47
    ...
    national_label_en: Open/hanging latrine
    national_label_local: Hanging toilet/hanging latrine
    jmp_classification: Latrines > Dry latrines > Improved latrines > Hanging toilet/hanging
      latrine
    jmp_id: latrines.dry_latrines.improved_latrines.hanging_toilet_hanging_latrine
  ...
  - country_entry_id: BGD-SAN-48
    ...
    national_label_en: '"Pit latrine with slab and water seal", "Pit latrine with
      slab & lid", "Pit latrine with slab but no lid, no water seal" +"Pit Latrine
      with slab and flap, no water seal"'
  ...
  - country_entry_id: BGD-SAN-52
    ...
    national_label_en: Single pit with slab
    national_label_local: Pit latrine with slab/covered latrine
    jmp_classification: Latrines > Dry latrines > Improved latrines > Pit latrine
      with slab/covered latrine
    jmp_id: latrines.dry_latrines.improved_latrines.pit_latrine_with_slab_covered_latrine
  ...
  - country_entry_id: BGD-SAN-53
    ...
    national_label_en: Open latrine
  ...
  - country_entry_id: BGD-SAN-64
    ...
    national_label_en: Pit latrine (slab and water seal)
    national_label_local: Pit latrine with slab/covered latrine
  ...
  - country_entry_id: BGD-SAN-66
    ...
    national_label_en: Pit latrine(slab, lib but no water seal; slab and sealed flaps
      but nothere is no water; slab but no water seal)
    national_label_local: Pit latrine with slab/covered latrine
  ...
  - country_entry_id: BGD-SAN-69
    ...
    national_label_en: Water sealed/slab latrine
    national_label_local: Pour flush latrines
    jmp_classification: Latrines > Pour flush latrines
    jmp_id: latrines.pour_flush_latrines
    gmd_target: ''
  ...
  - country_entry_id: BGD-SAN-70
    ...
    national_label_en: Water sealed/slab latrines
    national_label_local: Pour flush latrines
    jmp_classification: Latrines > Pour flush latrines
    jmp_id: latrines.pour_flush_latrines
    gmd_target: ''
  ...
  - country_entry_id: BGD-SAN-78
    ...
    national_label_en: No latrine/open space
    national_label_local: No facility, bush, field
    jmp_classification: No facility, bush, field
    jmp_id: no_facility_bush_field
    gmd_target: open
  ...
  - country_entry_id: BGD-SAN-80
    source_category_code: composting_toilet
    national_label_en: Composting toilet
    national_label_local: Other improved
...
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - country_entry_id: BGD-WAS-01
    ...
    national_label_en: Spring/Charha/Jhiri
  ...
  - country_entry_id: BGD-WAS-06
    ...
    national_label_en: Surface well
  ...
  - country_entry_id: BGD-WAS-07
    ...
    national_label_en: Surface well/Other well
    national_label_local: Traditional wells
    jmp_classification: Ground water > Traditional wells
    jmp_id: ground_water.traditional_wells
    gmd_target: ''
  ...
  - country_entry_id: BGD-WAS-08
    ...
    national_label_en: '"Shallow tube well (<500feet)"+"Deep tube well (500+feet)"'
  ...
  - country_entry_id: BGD-WAS-10
    ...
    national_label_en: Shallow tubewell (less than 250 feet)
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - country_entry_id: BGD-WAS-15
    ...
    national_label_en: Tubewell (deep, shallow)
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - country_entry_id: BGD-WAS-17
    ...
    national_label_en: Deep Tara pump
    national_label_local: Other
  ...
  - country_entry_id: BGD-WAS-18
    ...
    national_label_en: Deep tubewell (more than 250 feet)
  ...
  - country_entry_id: BGD-WAS-19
    ...
    national_label_en: Tubewell (deep)
    national_label_local: Private
    jmp_classification: Ground water > Tubewell, borehole > Private
    jmp_id: ground_water.tubewell_borehole.private
    gmd_target: borehole
  ...
  - country_entry_id: BGD-WAS-20
    ...
    national_label_en: Shallow Tara pump
  ...
  - country_entry_id: BGD-WAS-21
    ...
    national_label_en: Tubewell (shallow)
    national_label_local: Public
    jmp_classification: Ground water > Tubewell, borehole > Public
    jmp_id: ground_water.tubewell_borehole.public
    gmd_target: borehole
  ...
  - country_entry_id: BGD-WAS-26
    ...
    national_label_en: Tubewell/Tap/Ringwell
    national_label_local: Other improved sources
    jmp_classification: Other improved sources
  ...
  - country_entry_id: BGD-WAS-29
    ...
    national_label_en: Filter / arsenic filter
    national_label_local: Other
  ...
  - country_entry_id: BGD-WAS-30
    ...
    national_label_en: Reverse Osmosis plant/PSF
    national_label_local: Other
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other
    gmd_target: other
  ...
  - country_entry_id: BGD-WAS-31
    ...
    national_label_en: Water kiosk (water selling plant)
    national_label_local: Other
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other
    gmd_target: other
  ...
  - country_entry_id: BGD-WAS-32
    ...
    national_label_en: Arsenic removal plant
    national_label_local: Other
    jmp_classification: Other improved sources > Other
  ...
  - country_entry_id: BGD-WAS-33
    ...
    national_label_en: Pond sand filter
    national_label_local: Other
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other#2
    gmd_target: other
  ...
  - country_entry_id: BGD-WAS-34
    ...
    national_label_en: Water ATM booth
    national_label_local: Other
    jmp_classification: Other improved sources > Other
    jmp_id: other_improved_sources.other#2
    gmd_target: other
  ...
  - country_entry_id: BGD-WAS-37
    ...
    national_label_en: Disinfection water from rivers / dams / lakes / ponds / irrigation
      canals
    national_label_local: Other
  ...
  - country_entry_id: BGD-WAS-51
    ...
    national_label_en: Pond/ River/ Other
  ...
  - country_entry_id: BGD-WAS-52
    ...
    national_label_en: Pond/river/canal/lake
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - country_entry_id: BGD-WAS-58
    ...
    national_label_en: Water collected directly from rivers / dams / lakes / ponds
      / irrigation canals
    national_label_local: Other
    jmp_classification: Surface water > Other
    jmp_id: surface_water.other
  ...
  - country_entry_id: BGD-WAS-60
    ...
    national_label_en: Pond/tank/lake
    national_label_local: Pond
    jmp_classification: Surface water > Pond
    jmp_id: surface_water.pond
    gmd_target: surface
  ...
  - country_entry_id: BGD-WAS-64
    ...
    national_label_en: Tap/piped (supply)
    national_label_local: Other
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
  ...
  - country_entry_id: BGD-WAS-70
    ...
    national_label_en: Pped into dwelling
    national_label_local: Piped water into dwelling
    jmp_classification: Tap water > Piped on premises > Piped water into dwelling
    jmp_id: tap_water.piped_on_premises.piped_water_into_dwelling
    gmd_target: piped
  ...
  - country_entry_id: BGD-WAS-71
    ...
    national_label_en: Tap or pipe water inside the house
    national_label_local: Piped water into dwelling
    jmp_classification: Tap water > Piped on premises > Piped water into dwelling
    jmp_id: tap_water.piped_on_premises.piped_water_into_dwelling
    gmd_target: piped
  ...
  - country_entry_id: BGD-WAS-76
    ...
    national_label_en: Tap or pipe water in the yard
    national_label_local: Piped water to yard/plot
    jmp_classification: Tap water > Piped on premises > Piped water to yard/plot
    jmp_id: tap_water.piped_on_premises.piped_water_to_yard_plot
    gmd_target: piped
  ...
  - country_entry_id: BGD-WAS-78
    ...
    national_label_en: Piped outside residence
    national_label_local: Public tap, standpipe
    jmp_classification: Tap water > Public tap, standpipe
    jmp_id: tap_water.public_tap_standpipe
    gmd_target: piped
  ...
  - country_entry_id: BGD-WAS-81
    ...
    national_label_en: public tap/stabndpipe
    national_label_local: Public tap, standpipe
    jmp_classification: Tap water > Public tap, standpipe
    jmp_id: tap_water.public_tap_standpipe
    gmd_target: piped
