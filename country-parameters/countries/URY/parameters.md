...
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  - survey_labels: 1 - Montevideo Metropolitano
    ...
    gmd_subnatid1: URY_2015_GAULx_1
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '1'
    geo_nvar: ADM1_NAME
    geo_name: Canelones & Montevideo & San Jose
    source_row: 17456
  - survey_labels: 2 - Interior Norte
    survey_variables: subnatid | subnatidsurvey
    gmd_subnatid1: URY_2015_GAULx_2
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '2'
    geo_nvar: ADM1_NAME
    geo_name: Artigas & Rivera & Salto
    source_row: 17457
  - survey_labels: 3 - Interior Centro Norte
    survey_variables: subnatid | subnatidsurvey
    gmd_subnatid1: URY_2015_GAULx_3
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '3'
    geo_nvar: ADM1_NAME
    geo_name: Cerro Largo & Durazno & Paysandu & Rio Negro & Tacuarembo & Treinta
      Y Tres
    source_row: 17458
  - survey_labels: 4 - Interior Centro Sur
    survey_variables: subnatid | subnatidsurvey
    gmd_subnatid1: URY_2015_GAULx_4
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '4'
    geo_nvar: ADM1_NAME
    geo_name: Flores & Florida & Lavalleja & Rocha & Soriano
    source_row: 17459
  - survey_labels: 5 - Interior Sur
    survey_variables: subnatid | subnatidsurvey
    gmd_subnatid1: URY_2015_GAULx_5
    gmd_subnatid2: ''
    gmd_subnatid3: ''
    gmd_subnatid4: ''
    is_rep_subnat1: yes
    ...
    geo_id: '5'
    geo_nvar: ADM1_NAME
    geo_name: Canelones & Colonia & Maldonado & San Jose
    source_row: 17460
  provenance:
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - source_category_code: otro_superficie_etc
    national_label_en: Otro (superficie, etc.)
  ...
  - source_category_code: baldeo_a_otra_parte
    national_label_en: Baldeo a otra parte
    national_label_local: a drenaje abierto
  ...
  - source_category_code: servicio_sanitario_entubado_hacia_el_arroyo
    national_label_en: Servicio sanitario entubado hacia el arroyo
    national_label_local: a drenaje abierto
    jmp_classification: Flush/toilets > to elsewhere
    jmp_id: flush_toilets.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - source_category_code: inodoro_conectado_a_red_de_saneamiento
    national_label_en: Inodoro conectado a red de saneamiento
    national_label_local: al alcantarillado
  ...
  - source_category_code: servicio_sanitario_evacuado_a_red_general
    national_label_en: Servicio sanitario evacuado a red general
    national_label_local: al alcantarillado
    jmp_classification: Flush/toilets > to piped sewer system
    jmp_id: flush_toilets.to_piped_sewer_system
    gmd_target: flush_sewer
  ...
  - source_category_code: inodoro_o_taza_turca_letrina_conectado_a_a_pozo_permeable_perdedor
    national_label_en: Inodoro o taza turca (letrina) conectado/a a pozo permeable
      (perdedor)
  ...
  - source_category_code: sin_cisterna_fosa_septica_pozo_negro
    national_label_en: 'Sin cisterna: fosa septica, pozo negro'
  ...
  - source_category_code: sin_cisterna_red_general
    national_label_en: 'Sin cisterna: red general'
    national_label_local: Otro
    jmp_classification: Other improved > Other
    jmp_id: other_improved.other
    gmd_target: other
  ...
  - source_category_code: entubado_hacia_el_arroyo
    national_label_en: Entubado hacia el arroyo
    national_label_local: Otro
  ...
  - source_category_code: otros_superficie_etc
    national_label_en: Otros (superficie, etc.)
    national_label_local: Otro
    jmp_classification: Other unimproved > Other
    jmp_id: other_unimproved.other
    gmd_target: other
  ...
  - source_category_code: sin_cisterna_otro
    national_label_en: 'Sin cisterna: otro'
    national_label_local: Otro
    jmp_classification: Other unimproved > Other
...
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - source_category_code: manantial_o_pozo_surgente_protegido
    national_label_en: Manantial o pozo surgente protegido
  ...
  - source_category_code: pozo_surgente_protegido
    national_label_en: Pozo surgente protegido
    national_label_local: Pozos protegidos
    jmp_classification: Ground water > Protected well
    jmp_id: ground_water.protected_well
    gmd_target: protected_well
  ...
  - source_category_code: pozo_surgente
    national_label_en: Pozo surgente
  ...
  - source_category_code: manantial_o_pozo_surgente_no_protegido
    national_label_en: Manantial o pozo surgente no protegido
    national_label_local: Manantiales protegidos
  ...
  - source_category_code: pozo_surgente_no_protegido
    national_label_en: Pozo surgente no protegido
    national_label_local: Pozos non protegidos
    jmp_classification: Ground water > Unprotected well
    jmp_id: ground_water.unprotected_well
    gmd_target: unprotected_well
  ...
  - source_category_code: red_general_por_otros_medios
    national_label_en: Red general por otros medios
    national_label_local: Otro
  ...
  - source_category_code: tuberia_otro
    national_label_en: Tuberia (otro)
    national_label_local: Otro
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
  ...
  - source_category_code: tuberia_al_vecino
    national_label_en: Tuberia al vecino
    national_label_local: Otro
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
  ...
  - source_category_code: red_general_dentro_de_la_vivienda
    national_label_en: Red general dentro de la vivienda
    national_label_local: Agua entubada en la vivienda
    jmp_classification: Tap water > Piped on premises > Piped water into dwelling
    jmp_id: tap_water.piped_on_premises.piped_water_into_dwelling
    gmd_target: piped
  ...
  - source_category_code: red_general_fuera_de_la_vivienda_a_100m
    national_label_en: Red general fuera de la vivienda a  100m
    national_label_local: Agua corriente al patio/parcela
    jmp_classification: Tap water > Piped on premises > Piped water to yard/plot
    jmp_id: tap_water.piped_on_premises.piped_water_to_yard_plot
    gmd_target: piped
