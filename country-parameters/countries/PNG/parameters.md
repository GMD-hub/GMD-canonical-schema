...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - national_label_en: |-
    ...
    national_label_local: |-
      CTCS Certificate (Distance courses, bridging course to enter Bachelor degree)
      programme
    entry_age: 19
    duration_years: 1
    isced_level: '4'
  ...
  - national_label_en: Doctorate
    ...
    source_row: 27
  provenance:
    source: extraction\10_source\country-parameters-inputs\ISCED\ISCED_2011_Mapping_Papua_New_Guinea.xlsx
    verified_on: ~
    human_reviewed: no
    reviewer: ~
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  - survey_labels: 5-New Guinea Islands
    ...
    geo_id: '5'
    geo_nvar: ADM1_NAME
    geo_name: East New Britain & Manus & New Ireland & Northern Solomons & West New
      Britain
    source_row: 12384
  provenance:
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - source_category_code: other
    ...
    source_row: 137
  provenance:
    source: extraction\10_source\country-parameters-inputs\JMP\JMP_2025_PNG_Papua_New_Guinea_1.xlsx
    verified_on: ~
    human_reviewed: no
    reviewer: ~
