...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - national_label_en: Premier cycle fondamental
    ...
    source_row: 8
  - national_label_en: Deuxième cycle fondamental
    national_label_local: Deuxième cycle fondamental
    entry_age: 13
    duration_years: 3
    isced_level: '2'
  ...
  - national_label_en: Enseignement professionnel
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 12
  - national_label_en: Techniciens du premier cycle de santé
    national_label_local: Techniciens du premier cycle de santé
    entry_age: 17
    duration_years: 3
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 13
  - national_label_en: Formation des éducateurs du préscolaire
    national_label_local: Formation des éducateurs du préscolaire
    entry_age: 19
    duration_years: 4
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 14
  - national_label_en: Formation des maîtres  (Après DEF)
    national_label_local: Formation des maîtres (Après DEF)
    entry_age: 19
    duration_years: 4
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: Enseignement technique
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 16
  - national_label_en: Formation des maîtres  (Après baccalauréat)
    national_label_local: Formation des maîtres (Après baccalauréat)
    entry_age: 19
    duration_years: 2
    isced_level: '4'
    ...
    source_row: 17
  - national_label_en: Enseignement supérieur (DUTS)
    national_label_local: Enseignement supérieur (DUTS)
    entry_age: 19
    duration_years: 2
    isced_level: '5'
  ...
  - national_label_en: Enseignement supérieur (BTS)
    ...
    gmd_educat7_target: tertiary
    source_row: 19
  - national_label_en: Enseignement supérieur (DTSS)
    national_label_local: Enseignement supérieur (DTSS)
    entry_age: 19
    duration_years: 3
    isced_level: '5'
    isced_label: ISCED 5 Short-cycle tertiary
    ...
    gmd_educat7_target: tertiary
    source_row: 20
  - national_label_en: Enseignement supérieur (DEUG / DUEL)
    national_label_local: Enseignement supérieur (DEUG / DUEL)
    entry_age: 19
    duration_years: 2
    isced_level: '6'
  ...
  - national_label_en: Enseignement supérieur (Licence)
    ...
    gmd_educat7_target: tertiary
    source_row: 22
  - national_label_en: Enseignement supérieur (Maitrise)
    national_label_local: Enseignement supérieur (Maitrise)
    entry_age: 23
    duration_years: 1
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 23
  - national_label_en: Enseignement supérieur (Ingenieur)
    national_label_local: Enseignement supérieur (Ingenieur)
    entry_age: 19
    duration_years: 5
    isced_level: '7'
    ...
    gmd_educat7_target: tertiary
    source_row: 24
  - national_label_en: Médecine et pharmacie
    national_label_local: Médecine et pharmacie
    entry_age: 19
    duration_years: 7
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
  ...
  - national_label_en: Enseignement supérieur (DEA)
    ...
    gmd_educat7_target: tertiary
    source_row: 27
  - national_label_en: Enseignement supérieur  (Ingenieur après licence)
    national_label_local: Enseignement supérieur (Ingenieur après licence)
    entry_age: 23
    duration_years: 2
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
  ...
  - national_label_en: Enseignement supérieur  (Doctorat)
    ...
    gmd_educat7_target: tertiary
    source_row: 30
  - national_label_en: Enseignement supérieur (Medecine)
    national_label_local: Enseignement supérieur (Medecine)
    entry_age: 25
    duration_years: 3
    isced_level: '8'
    isced_label: ISCED 8 Doctoral or equivalent
...
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  - survey_labels: 3 - Sikasso | 3 – Sikasso
    ...
    geo_name: Sikasso
    source_row: 10108
  - survey_labels: 4 - Segou | 4 - S�gou | 4 – Ségou
    survey_variables: subnatid | subnatidsurvey
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - source_category_code: chasse_branchee_a_autre_chose
    national_label_en: Chasse branchée à autre chose
  ...
  - source_category_code: chasse_branchee_ailleurs
    national_label_en: Chasse branchée ailleurs
    national_label_local: reliée al'air libre
    jmp_classification: Flush and pour flush > to elsewhere
    jmp_id: flush_and_pour_flush.to_elsewhere
    gmd_target: flush_elsewhere
  ...
  - source_category_code: chasse_branchee_a_l_egout
    national_label_en: Chasse branchée à l'égout
  ...
  - source_category_code: chasse_d_eau_manuelle_branchee_a_l_egout
    national_label_en: Chasse d'eau/manuelle branchée à l'égout
    national_label_local: reliée a systeme d'egouts
    jmp_classification: Flush and pour flush > to piped sewer system
    jmp_id: flush_and_pour_flush.to_piped_sewer_system
    gmd_target: flush_sewer
  ...
  - source_category_code: chasse_branchee_a_latrines
    national_label_en: Chasse branchée à latrines
  ...
  - source_category_code: chasse_d_eau_manuelle_branchee_a_latrines
    national_label_en: Chasse d'eau/manuelle branchée à latrines
    national_label_local: reliée aux latrine
    jmp_classification: Flush and pour flush > to pit
    jmp_id: flush_and_pour_flush.to_pit
    gmd_target: flush_pit
  ...
  - source_category_code: chasse_branchee_a_fosse_septique
    national_label_en: Chasse branchée à fosse septique
  ...
  - source_category_code: chasse_branchee_a_un_endroit_inconnu_pas_sur
    national_label_en: Chasse branchée à un endroit inconnu/pas sûr
  ...
  - source_category_code: chasse_d_eau_manuelle_branchee_a_un_endroit_inconnu_pas_sur
    national_label_en: Chasse d'eau/manuelle branchée à un endroit inconnu/pas sûr
    national_label_local: reliée a autre chose
    jmp_classification: Flush and pour flush > to unknown place/ not sure/DK
    jmp_id: flush_and_pour_flush.to_unknown_place_not_sure_dk
    gmd_target: flush_elsewhere
  ...
  - source_category_code: chasse_d_eau_avec_evacuation
    national_label_en: Chasse d'eau avec évacuation
  ...
  - source_category_code: w_c_interieur_exterieur_avec_chasse_eau
    national_label_en: W.C. intérieur/extérieur avec chasse eau
    national_label_local: Toilette à chasse d'eau
    jmp_classification: Flush/toilets
    jmp_id: flush_toilets
    gmd_target: ''
  ...
  - source_category_code: chasse_d_eau_interieure_ou_exterieure_privee
    national_label_en: Chasse d'eau intérieure ou extérieure privée
  ...
  - source_category_code: chasse_d_eau_chasse_manuelle_non_reliee_aux_egouts_fosse
    national_label_en: Chasse d’eau/chasse manuelle non reliée aux égouts/fosse
    national_label_local: reliée al'air libre
  ...
  - source_category_code: prive_avec_chasse_eau
    national_label_en: Privé avec chasse eau
    national_label_local: reliée a autre chose
  ...
  - source_category_code: chasse_d_eau_a_plusieurs_menages
    national_label_en: Chasse d'eau à plusieurs ménages
  ...
  - source_category_code: commun_a_plusieurs_menages_avec_chasse_eau
    national_label_en: Commun à plusieurs ménages avec chasse eau
    national_label_local: reliée a autre chose
  ...
  - source_category_code: latrines_a_fosses_sans_dalle
    national_label_en: Latrines à fosses sans dalle
    national_label_local: Latrine a fosse sans dalle
    jmp_classification: Latrines > Dry latrines > Improved latrines > Pit latrine
      without slab/open pit
    jmp_id: latrines.dry_latrines.improved_latrines.pit_latrine_without_slab_open_pit
  ...
  - source_category_code: latrines_a_fosses_sans_dalle_trou_ouvert
    national_label_en: Latrines à fosses sans dalle/trou ouvert
    national_label_local: Latrine a fosse sans dalle
    jmp_classification: Latrines > Dry latrines > Improved latrines > Pit latrine
      without slab/open pit
    jmp_id: latrines.dry_latrines.improved_latrines.pit_latrine_without_slab_open_pit
  ...
  - source_category_code: latrines_ameliorees_ventilees
    national_label_en: Latrines ameliorées ventilées
  ...
  - source_category_code: latrines_ameliorees_ventilees_lav
    national_label_en: Latrines ameliorées ventilées (LAV)
    national_label_local: Latrine a fosse ameliorée ventilée
    jmp_classification: Latrines > Dry latrines > Improved latrines > Ventilated Improved
      Pit latrine
    jmp_id: latrines.dry_latrines.improved_latrines.ventilated_improved_pit_latrine
  ...
  - source_category_code: latrines_a_plusieurs_menages
    national_label_en: Latrines à plusieurs ménages
  ...
  - source_category_code: latrines_communes_a_plusieurs_menages
    national_label_en: Latrines communes à plusieurs ménages
    national_label_local: Latrine traditionelle
  ...
  - source_category_code: autre_non_determine
    national_label_en: Autre/Non déterminé
    national_label_local: Autre
    jmp_classification: Other unimproved > Other
    jmp_id: other_unimproved.other
    gmd_target: other
...
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - source_category_code: puits_a_pompe_equipe_de_pmh
    national_label_en: Puits à pompe/équipé de PMH
    national_label_local: Autre
  ...
  - source_category_code: puits_moderne_protege
    national_label_en: Puits moderne protégé
    national_label_local: Privé
    jmp_classification: Ground water > Protected well > Private
    jmp_id: ground_water.protected_well.private
    gmd_target: protected_well
  ...
  - source_category_code: puits_moderne_non_protege
    national_label_en: Puits moderne non protégé
    national_label_local: Puits non-protegées
    jmp_classification: Ground water > Unprotected well
    jmp_id: ground_water.unprotected_well
    gmd_target: unprotected_well
  ...
  - source_category_code: fleuve_riviere_lac
    national_label_en: Fleuve, rivière, lac
    national_label_local: Eau de surface
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
