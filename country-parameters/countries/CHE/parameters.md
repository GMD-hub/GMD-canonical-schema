...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - national_label_en: vocational education, in dual system 2 years.
    national_label_local: 2-jährige berufliche Grundbildung mit Berufsattest /  formation
      ...
      di due anni con certificato federale d
    entry_age: 15
    duration_years: 2
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: |-
    ...
    national_label_local: Berufliche Grundbildung mit Eidgenössischem Fähigkeitszeugnis
      3-4 Jahre/  formation professionnelle initiale aboutissant à un certificat fédéral
      de capacité 3 - 4 ans/ formazione professionale di base della durata di due
      anni con attestato federale di cap
    entry_age: 15
    duration_years: 3
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: teacher education diploma for upper secondary level teaching
    ...
    national_label_local: Lehrdiplom Sek. II / Universität Weiterbildung /Aufbau-
      ...
      universitaire/ Etudes spécialisées et approfondies
    entry_age: 24
    duration_years: 1
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
