...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - country_entry_id: MOZ-SAN-08
    ...
    national_label_en: Sanita ligada a latrina
    national_label_local: to pit
    jmp_classification: Flush and pour flush > to pit
    jmp_id: flush_and_pour_flush.to_pit
    gmd_target: flush_pit
  ...
  - country_entry_id: MOZ-SAN-14
    ...
    national_label_en: Retrete com autoclismo
    national_label_local: Flush/toilets
    jmp_classification: Flush/toilets
    jmp_id: flush_toilets
    gmd_target: ''
  ...
  - country_entry_id: MOZ-SAN-15
    ...
    national_label_en: Flush in house
  ...
  - country_entry_id: MOZ-SAN-16
    ...
    national_label_en: Public flush
  ...
  - country_entry_id: MOZ-SAN-18
    ...
    national_label_en: Casa de banho com rde esgotos (sewerage)
    national_label_local: to piped sewer system
  ...
  - country_entry_id: MOZ-SAN-26
    ...
    national_label_en: Letrine
    national_label_local: Latrines
    jmp_classification: Latrines
    jmp_id: latrines
    gmd_target: ''
  ...
  - country_entry_id: MOZ-SAN-31
    ...
    national_label_en: Latrina melhorada tradicional
    national_label_local: Pit latrine with slab/covered latrine
    jmp_classification: Latrines > Dry latrines > Improved latrines > Pit latrine
      with slab/covered latrine
    jmp_id: latrines.dry_latrines.improved_latrines.pit_latrine_with_slab_covered_latrine
  ...
  - country_entry_id: MOZ-SAN-32
    ...
    national_label_en: Latrina tradicional melhorada
    national_label_local: Pit latrine with slab/covered latrine
    jmp_classification: Latrines > Dry latrines > Improved latrines > Pit latrine
      with slab/covered latrine
    jmp_id: latrines.dry_latrines.improved_latrines.pit_latrine_with_slab_covered_latrine
  ...
  - country_entry_id: MOZ-SAN-39
    ...
    national_label_en: Latrina nao melhorade
  ...
  - country_entry_id: MOZ-SAN-43
    ...
    national_label_en: Latrina melhorado e ventilado (VIP)
    national_label_local: Ventilated Improved Pit latrine
    jmp_classification: Latrines > Dry latrines > Improved latrines > Ventilated Improved
      Pit latrine
    jmp_id: latrines.dry_latrines.improved_latrines.ventilated_improved_pit_latrine
  ...
  - country_entry_id: MOZ-SAN-44
    ...
    national_label_en: Letrina Melhorada
    national_label_local: Ventilated Improved Pit latrine
    jmp_classification: Latrines > Dry latrines > Improved latrines > Ventilated Improved
      Pit latrine
    jmp_id: latrines.dry_latrines.improved_latrines.ventilated_improved_pit_latrine
  ...
  - country_entry_id: MOZ-SAN-47
    ...
    national_label_en: Retrete sem autoclismo
  ...
  - country_entry_id: MOZ-SAN-48
    ...
    national_label_en: no flush to somewhere else
    national_label_local: to elsewhere
  ...
  - country_entry_id: MOZ-SAN-49
    ...
    national_label_en: no flush to piped sewer system
    national_label_local: to piped sewer system
  ...
  - country_entry_id: MOZ-SAN-50
    ...
    national_label_en: no flush to septic tank
    national_label_local: to septic tank
  ...
  - country_entry_id: MOZ-SAN-51
    ...
    national_label_en: no flush, don't know where
    national_label_local: to unknown place/ not sure/DK
  ...
  - country_entry_id: MOZ-SAN-55
    ...
    national_label_en: Nao tem latrina/no mato
    national_label_local: No facility, bush, field
    jmp_classification: No facility, bush, field
    jmp_id: no_facility_bush_field
    gmd_target: open
  ...
  - country_entry_id: MOZ-SAN-62
    ...
    national_label_en: Sem retrete/ Latrina
    national_label_local: No facility, bush, field
    jmp_classification: No facility, bush, field
    jmp_id: no_facility_bush_field
    gmd_target: open
  ...
  - country_entry_id: MOZ-SAN-65
    ...
    national_label_en: Na praia (on the beach)
    national_label_local: Other
...
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - country_entry_id: MOZ-WAS-01
    ...
    national_label_en: Neighbour's well
    national_label_local: Other
  ...
  - country_entry_id: MOZ-WAS-05
    ...
    national_label_en: Nascentes protegidas
    national_label_local: Protected spring
    jmp_classification: Ground water > Protected spring
    jmp_id: ground_water.protected_spring
    gmd_target: protected_spring
  ...
  - country_entry_id: MOZ-WAS-10
    ...
    national_label_en: Poco protegido sem bomba
    national_label_local: Protected well
    jmp_classification: Ground water > Protected well
    jmp_id: ground_water.protected_well
    gmd_target: protected_well
  ...
  - country_entry_id: MOZ-WAS-14
    ...
    national_label_en: protected well (without manual pump)
    national_label_local: Protected well
    jmp_classification: Ground water > Protected well
    jmp_id: ground_water.protected_well
    gmd_target: protected_well
  ...
  - country_entry_id: MOZ-WAS-15
    ...
    national_label_en: Sem bomba manual
    national_label_local: Protected well
    jmp_classification: Ground water > Protected well
    jmp_id: ground_water.protected_well
    gmd_target: protected_well
  ...
  - country_entry_id: MOZ-WAS-21
    source_category_code: poco_ou_furo_com_bomba_manual
    national_label_en: Poco ou furo com bomba manual
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - country_entry_id: MOZ-WAS-24
    ...
    national_label_en: tube well or borehole (with manual pump)
    national_label_local: Tubewell, borehole
    jmp_classification: Ground water > Tubewell, borehole
    jmp_id: ground_water.tubewell_borehole
    gmd_target: borehole
  ...
  - country_entry_id: MOZ-WAS-27
    ...
    national_label_en: Nascentes nao protegidas
    national_label_local: Unprotected spring
    jmp_classification: Ground water > Unprotected spring
    jmp_id: ground_water.unprotected_spring
    gmd_target: unprotected_spring
  ...
  - country_entry_id: MOZ-WAS-30
    ...
    national_label_en: Poco nao protegido
  ...
  - country_entry_id: MOZ-WAS-39
    ...
    national_label_en: Cisterna (tanque movel ou camiao)
    national_label_local: Tanker truck provided
    jmp_classification: Other improved sources > Tanker truck provided
    jmp_id: other_improved_sources.tanker_truck_provided
    gmd_target: tanker
  ...
  - country_entry_id: MOZ-WAS-57
    ...
    national_label_en: Rio, lago e lagoa
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - country_entry_id: MOZ-WAS-58
    ...
    national_label_en: Rio, lago, lagoa
    national_label_local: Surface water
    jmp_classification: Surface water
    jmp_id: surface_water
    gmd_target: surface
  ...
  - country_entry_id: MOZ-WAS-72
    ...
    national_label_en: Neighbor's house
    national_label_local: Other
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
  ...
  - country_entry_id: MOZ-WAS-73
    ...
    national_label_en: Neighbour's piped connection
    national_label_local: Other
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
  ...
  - country_entry_id: MOZ-WAS-74
    ...
    national_label_en: Piped inside neighbour's house or land
    national_label_local: Other
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
  ...
  - country_entry_id: MOZ-WAS-75
    ...
    national_label_en: Piped into neighbour's yard/plot
    national_label_local: Other
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
  ...
  - country_entry_id: MOZ-WAS-79
    ...
    national_label_en: Dentro da casa
    national_label_local: Piped water into dwelling
    jmp_classification: Tap water > Piped on premises > Piped water into dwelling
    jmp_id: tap_water.piped_on_premises.piped_water_into_dwelling
    gmd_target: piped
  ...
  - country_entry_id: MOZ-WAS-80
    ...
    national_label_en: Own piped connection
    national_label_local: Piped water into dwelling
    jmp_classification: Tap water > Piped on premises > Piped water into dwelling
    jmp_id: tap_water.piped_on_premises.piped_water_into_dwelling
    gmd_target: piped
  ...
  - country_entry_id: MOZ-WAS-85
    ...
    national_label_en: Fora da casa/quintal
    national_label_local: Piped water to yard/plot
    jmp_classification: Tap water > Piped on premises > Piped water to yard/plot
    jmp_id: tap_water.piped_on_premises.piped_water_to_yard_plot
    gmd_target: piped
  ...
  - country_entry_id: MOZ-WAS-86
    ...
    national_label_en: Piped in own land
    national_label_local: Piped water to yard/plot
    jmp_classification: Tap water > Piped on premises > Piped water to yard/plot
    jmp_id: tap_water.piped_on_premises.piped_water_to_yard_plot
    gmd_target: piped
