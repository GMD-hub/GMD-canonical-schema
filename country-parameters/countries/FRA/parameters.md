...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - country_entry_id: FRA-EDU-08
    ...
    national_label_local: Enseignement de second cycle professionnel des écoles sanitaires
      et sociales conduisant aux diplômes d'auxiliaires de puériculture et équivalents
    entry_age: 18
    duration_years: 1
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - country_entry_id: FRA-EDU-20
    ...
    national_label_local: Enseignement dispensé en écoles spécialisées ou à l'université
      conduisant principalement aux diplômes professionnels paramédicaux et sociaux,
      et à quelques diplômes professionnels de technologie, de droit et d'art, commerce
    entry_age: 18
    duration_years: 2
    isced_level: '5'
    isced_label: ISCED 5 Short-cycle tertiary
  ...
  - country_entry_id: FRA-EDU-26
    ...
    national_label_local: Préparation à l'examen d'entrée et certificat de formation
      à la profession d'avocat, Préparation au concours d'accès à l'Ecole Nationale
      de la Magistrature, Préparation aux concours administratifs de niveau équivalent.
    entry_age: 21
    duration_years: 0
    isced_level: '7'
