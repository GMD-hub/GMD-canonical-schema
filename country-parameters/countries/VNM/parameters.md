...
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - country_entry_id: VNM-WAS-97
    ...
    source_row: 41
  provenance:
    source: extraction\10_source\country-parameters-inputs\JMP\JMP_2025_VNM_Viet_Nam_1.xlsx
    verified_on: null
    human_reviewed: false
    reviewer: null
...
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  - country_entry_id: VNM-SUBNAT-01
    ...
    gmd_subnatidsurvey: VNM_2015_GAULx_1
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
  ...
  - country_entry_id: VNM-SUBNAT-02
    ...
    is_rep_subnat4: false
    representative_level: 1
    gmd_subnatidsurvey: VNM_2015_GAULx_2
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
    geo_id: '2'
    geo_nvar: ADM1_NAME
    geo_name: Bac Giang & Bac Kan & Cao Bang & Dien Bien & Ha Giang & Hoa Binh & Lai
  ...
  - country_entry_id: VNM-SUBNAT-03
    ...
    is_rep_subnat4: false
    representative_level: 1
    gmd_subnatidsurvey: VNM_2015_GAULx_3
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
    geo_id: '3'
    geo_nvar: ADM1_NAME
    geo_name: Binh Dinh & Binh Thuan & Da Nang City & Ha Tinh & Khanh Hoa & Nghe An
  ...
  - country_entry_id: VNM-SUBNAT-04
    ...
    is_rep_subnat4: false
    representative_level: 1
    gmd_subnatidsurvey: VNM_2015_GAULx_4
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
  ...
  - country_entry_id: VNM-SUBNAT-05
    ...
    is_rep_subnat4: false
    representative_level: 1
    gmd_subnatidsurvey: VNM_2015_GAULx_5
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
  ...
  - country_entry_id: VNM-SUBNAT-06
    ...
    is_rep_subnat4: false
    representative_level: 1
    gmd_subnatidsurvey: VNM_2015_GAULx_6
    geo_year: '2015'
    geo_source: GAUL
    geo_level: x
    geo_idvar: sample
    geo_id: '6'
    geo_nvar: ADM1_NAME
    geo_name: An Giang & Bac Lieu & Ben Tre & Ca Mau & Can Tho city & Dong Thap &
      Hau Giang & Kien Giang & Long An & Soc Trang & Tien Giang & Tra Vinh & Vinh
      Long
    source_row: 18455
  provenance:
...
This file promotes the VNM extraction example into the governed country
parameter structure (`parameters.md` + `exceptions.md`).

## Parameter notes

### PARAM-EDU-LEVEL-CROSSWALK

- Source: UNESCO ISCED workbook extraction for Viet Nam.
- Purpose: maps national education rows to GMD education targets.
- Notes: keep row-level labels and `source_row` for traceability.
- Validity rule: unless era-specific education systems are explicitly defined,
  this record is applied from 1990 onward (`effective_from: 1990`).

### PARAM-WASH-WATER-CROSSWALK

- Source: JMP 2025 VNM workbook extraction (water domain).
- Purpose: maps national water-source labels to JMP classes and GMD targets.
- Notes: benchmark-only metrics remain outside executable country canon.

### PARAM-WASH-SANITATION-CROSSWALK

- Source: JMP 2025 VNM workbook extraction (sanitation domain).
- Purpose: maps national sanitation labels to JMP classes and GMD targets.
- Notes: keep `improved_flag` and `shared_flag` as explicit row attributes.

## Verification status

All records currently remain draft with `human_reviewed: false` pending
human verification and GPID Team approval.

## Change log

| Date | Version | Change | Authority |
|---|---|---|---|
| 2026-09-06 | 0.2 | Promote VNM extraction example into country parameter structure | GPID Team |
