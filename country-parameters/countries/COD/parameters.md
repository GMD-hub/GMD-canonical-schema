...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - national_label_en: Education de base - Enseignement primaire
    ...
    source_row: 8
  - national_label_en: Education de base- "7ème et 8ème année "
    national_label_local: Education de base- "7ème et 8ème années "
    entry_age: 12
    duration_years: 2
    isced_level: '2'
  ...
  - national_label_en: Premier cycle du secondaire (professionnel)
    ...
    gmd_educat7_target: lower_secondary_complete
    source_row: 10
  - national_label_en: Premier cycle du secondaire (Arts et métiers, 1ans)
    national_label_local: Premier cycle du secondaire (Arts et métiers, 1ans)
    entry_age: 12
    duration_years: 1
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    source_row: 11
  - national_label_en: Premier cycle du secondaire (Arts et métiers, 2-3 ans)
    national_label_local: Premier cycle du secondaire (Arts et métiers, 2-3 ans)
    entry_age: 12
    duration_years: 2
    isced_level: '2'
    isced_label: ISCED 2 Lower secondary
    ...
    gmd_educat7_target: lower_secondary_complete
    source_row: 12
  - national_label_en: Deuxième cycle du secondaire (Général et Normal, cycle long)
    national_label_local: Deuxième cycle du secondaire (Général et Normal, cycle long)
    entry_age: 14
    duration_years: 4
    isced_level: '3'
    ...
    source_row: 13
  - national_label_en: Deuxième cycle professionnel (1 ans)
    national_label_local: Deuxième cycle professionnel (1 ans)
    entry_age: 15
    duration_years: 1
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
    ...
    source_row: 14
  - national_label_en: Deuxième cycle professionnel (2 ans)
    national_label_local: Deuxième cycle professionnel (2 ans)
    entry_age: 15
    duration_years: 2
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 15
  - national_label_en: Deuxième cycle du technique secondaire cycle long
    national_label_local: Deuxième cycle du technique secondaire cycle long
    entry_age: 14
    duration_years: 4
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
    ...
    gmd_educat7_target: upper_secondary_complete
    source_row: 16
  - national_label_en: Secrétaire de direction
    national_label_local: Secrétaire de direction
    entry_age: 18
    duration_years: 2
    isced_level: '4'
    ...
    source_row: 17
  - national_label_en: Enseignement supérieur technique, Diplôme A1
    national_label_local: Enseignement supérieur technique, Diplôme A1
    entry_age: 18
    duration_years: 3
    isced_level: '5'
    ...
    gmd_educat7_target: tertiary
    source_row: 18
  - national_label_en: Enseignement supérieur, premier cycle, Année préparatoire (Ingéniorat)
    national_label_local: Enseignement supérieur, premier cycle, Année préparatoire
      (Ingéniorat)
    entry_age: 18
    duration_years: 1
    isced_level: '6'
  ...
  - national_label_en: Enseignement supérieur, premier cycle, Année préparatoire (Ingéniorat
    ...
    gmd_educat7_target: tertiary
    source_row: 20
  - national_label_en: Enseignement supérieur, premier cycle
    national_label_local: Enseignement supérieur, premier cycle
    entry_age: 18
    duration_years: 3
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 21
  - national_label_en: Enseignement supérieur, premier cycle (Ingéniorat technicien)
    national_label_local: Enseignement supérieur, premier cycle (Ingéniorat technicien)
    entry_age: 19
    duration_years: 3
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 22
  - national_label_en: Enseignement supérieur, premier cycle (Ingéniorat)
    national_label_local: Enseignement supérieur, premier cycle (Ingéniorat)
    entry_age: 19
    duration_years: 5
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 23
  - national_label_en: Enseignement supérieur second cycle
    national_label_local: Enseignement supérieur second cycle
    entry_age: 21
    duration_years: 2
    isced_level: '7'
    ...
    gmd_educat7_target: tertiary
    source_row: 24
  - national_label_en: 'Enseignement supérieur second cycle: Médecine humaine et vétérinaire'
    national_label_local: 'Enseignement supérieur second cycle: Médecine humaine et
      vétérinaire'
    entry_age: 21
    duration_years: 4
    isced_level: '7'
    ...
    gmd_educat7_target: tertiary
    source_row: 25
  - national_label_en: Enseignement supérieur, troisième cycle (DES)
    national_label_local: Enseignement supérieur, troisième cycle (DES)
    entry_age: 23
    duration_years: 2
    isced_level: '7'
    isced_label: ISCED 7 Master or equivalent
    ...
    gmd_educat7_target: tertiary
    source_row: 26
  - national_label_en: Enseignement supérieur, troisième cycle (Doctorat)
    national_label_local: Enseignement supérieur, troisième cycle (Doctorat)
    entry_age: 25
    duration_years: 3
    isced_level: '8'
  ...
  - national_label_en: Enseignement supérieur (Spécialisation en médecine)
    ...
    gmd_educat7_target: tertiary
    source_row: 28
  - national_label_en: 'Professeur en médecine: Enseignement supérieur (Agrégation
      en Médecine)'
    national_label_local: 'Professeur en médecine: Enseignement supérieur (Agrégation
      en Médecine)'
    entry_age: 28
    duration_years: 3
    isced_level: '8'
...
- parameter_id: PARAM-GEO-GMD-CROSSWALK
  ...
  - survey_labels: 70 - Katanga
    ...
    geo_name: Katanga
    source_row: 2482
  - survey_labels: 80 - Kasaï Oriental
    survey_variables: subnatid
    ...
    source_row: 2483
  - survey_labels: 90 - Kasaï Occidental
    survey_variables: subnatid
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - source_category_code: interieur_exterieur_prive_avec_chasse_d_eau
    national_label_en: Intérieur/Extérieur privé avec chasse d'eau
  ...
  - source_category_code: interieur_exterieur_prive_chasse_eau
    national_label_en: Intérieur/Extérieur privé chasse eau
    national_label_local: Toilette à chasse d'eau (privée)
    jmp_classification: Flush/toilets > Private flush/toilet
    jmp_id: flush_toilets.private_flush_toilet
    gmd_target: ''
  ...
  - source_category_code: commun_a_plusieurs_menages_chasse_eau
    national_label_en: Commun à plusieurs ménages (chasse eau)
  ...
  - source_category_code: commun_a_plusieurs_menages_avec_chasse_d_eau
    national_label_en: Commun à plusieurs ménages, avec chasse d'eau
    national_label_local: Toilette à chasse d'eau (publique/partagée)
    jmp_classification: Flush/toilets > Public/shared flush/toilet
    jmp_id: flush_toilets.public_shared_flush_toilet
    gmd_target: ''
  ...
  - source_category_code: chasse_raccordee_a_l_egout
    national_label_en: Chasse raccordée à l'égout
    national_label_local: reliée a systeme d'egouts
    jmp_classification: Flush/toilets > to piped sewer system
    jmp_id: flush_toilets.to_piped_sewer_system
    gmd_target: flush_sewer
  ...
  - source_category_code: latrines_amenagees_publiques
    national_label_en: Latrines aménagées Publiques
    national_label_local: Latrine traditionelle
    jmp_classification: Latrines > Dry latrines > Improved latrines > Traditional
      latrine
    jmp_id: latrines.dry_latrines.improved_latrines.traditional_latrine
  ...
  - source_category_code: latrines_ameliorees_ventilees_lav
    national_label_en: Latrines améliorées ventilees (LAV)
    national_label_local: Latrine a fosse ameliorée ventilée
    jmp_classification: Latrines > Dry latrines > Improved latrines > Ventilated Improved
      Pit latrine
    jmp_id: latrines.dry_latrines.improved_latrines.ventilated_improved_pit_latrine
  ...
  - source_category_code: latrines_amenagees_privees
    national_label_en: Latrines aménagées privées
    national_label_local: Latrine a fosse avec dalle
...
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - source_category_code: puit_proteges
    national_label_en: Puit protégés
    national_label_local: Puits protegées
    jmp_classification: Ground water > Protected well
    jmp_id: ground_water.protected_well
    gmd_target: protected_well
  ...
  - source_category_code: robinet_d_un_autre_menage
    national_label_en: Robinet d'un autre ménage
    national_label_local: Autre
    jmp_classification: Tap water > Other
    jmp_id: tap_water.other
    gmd_target: piped
