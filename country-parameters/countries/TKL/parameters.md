...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - national_label_en: Early Childhood Education
    national_label_local: Vahega Pepe
    entry_age: 3
    duration_years: 2
    isced_level: '0'
...
- parameter_id: PARAM-WASH-SANITATION-CROSSWALK
  ...
  - source_category_code: private_tank_flush_inside_the_house
    national_label_en: Private tank flush inside the house
  ...
  - source_category_code: tank_flush_shared_with_other_households
    national_label_en: Tank flush shared with other households
  ...
  - source_category_code: private_tank_flush_outside_the_house
    national_label_en: Private tank flush outside the house
  ...
  - source_category_code: ocean_and_none
    national_label_en: Ocean and none
...
- parameter_id: PARAM-WASH-WATER-CROSSWALK
  ...
  - source_category_code: from_another_household
    national_label_en: from another household
    national_label_local: Other
  ...
  - source_category_code: water_tank_shared_with_other_households
    national_label_en: Water tank shared with other households
    national_label_local: Other
  ...
  - source_category_code: private_household_tank
    national_label_en: Private household tank
