...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - national_label_en: Vocational training programmes for adult persons that enable
    ...
    national_label_local: Programi osposobljavanja za odrasle koji omogućuju pristup
      tržištu rada, a ne vode nastavku obrazovanja. Uvjet upisa je završena razina
      2
    entry_age: 15
    duration_years: 120
    isced_level: '3'
  ...
  - national_label_en: Vocational education programmes within adult education system
      ...
      level 3
    national_label_local: Programi strukovnog obrazovanja u trajanju od jedne godine
      u sklopu obrazovanja odraslih koji omogućuju ulazak na tržište rada i upis u
      programe obrazovanja odraslih na ISCED razini 3
    entry_age: 15
    duration_years: 1
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: Vocational education programmes within regular education system
    ...
    national_label_local: Programi strukovnog obrazovanja u trajanju od tri  godine
      u sklopu redovnog obrazovanja koji omogućuju ulazak na tržište rada i upis u
      programe 03.08
    entry_age: 15
    duration_years: 3
    isced_level: '3'
  ...
  - national_label_en: Vocational education programmes within adult education system
    ...
    national_label_local: Programi strukovnog obrazovanja u trajanju od tri godine
      u sklopu obrazovanja odraslih koji omogućuju ulazak na tržište rada i upis u
      programe obrazovanja odraslih 03.09
    entry_age: 15
    duration_years: 3
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: Vocational education programmes within regular education system
    ...
    national_label_local: Programi strukovnog obrazovanja u trajanju četiri ili više
      godina u sklopu redovnog obrazovanja koji omogućuju ulazak na tržište rada i
      upis u programe na ISCED razini 5 i 6
    entry_age: 15
    duration_years: 4
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: Vocational education programmes within adult education system
    ...
    national_label_local: Programi strukovnog obrazovanja u trajanju četiri u sklopu
      obrazovanja odraslih koji omogućuju ulazak na tržište rada i upis u programe
      na ISCED razini 5 i 6
    entry_age: 15
    duration_years: 4
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
