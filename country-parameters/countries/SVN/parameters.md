...
- parameter_id: PARAM-EDU-LEVEL-CROSSWALK
  ...
  - national_label_en: Basic education (grades 1-6), lower educational standard
    national_label_local: Osnovnošolsko izobraževanje (1.-6. razred), nižji izobrazbeni
      standard
    entry_age: 6
    duration_years: 6
    isced_level: '1'
  ...
  - national_label_en: Special education programme (for special education needs children)
    national_label_local: Posebni program vzgoje in izobraževanja (za otroke in mladostnike
  ...
  - national_label_en: Basic education (grades  7-9); lower educational standard
    national_label_local: Osnovnošolsko izobraževanje (7.-9. razred), nižji izobrazbeni
      standard
    entry_age: 12
    duration_years: 3
    isced_level: '2'
  ...
  - national_label_en: 'General upper secondary education (general: gimnazija and
    ...
    national_label_local: 'Srednje splošno izobraževanje (splošna: gimnazija in klasična
      gimnazija; strokovna: ekonomska, tehniška, umetniška, mednarodna gimnazija)'
    entry_age: 15
    duration_years: 4
    isced_level: '3'
    isced_label: ISCED 3 Upper secondary
  ...
  - national_label_en: Professional study programmes (first-cycle higher education)
    national_label_local: Visokošolsko strokovno izobraževanje (1. bolonjska stopnja)
    entry_age: 19
    duration_years: 3
    isced_level: '6'
  ...
  - national_label_en: Academic study programmes (first cycle higher education)
    national_label_local: Visokošolsko univerzitetno izobraževanje (1. bolonjska stopnja)
    entry_age: 19
    duration_years: 3
    isced_level: '6'
    isced_label: ISCED 6 Bachelor or equivalent
