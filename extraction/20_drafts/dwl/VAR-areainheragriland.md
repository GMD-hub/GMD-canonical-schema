...
# --- Identity ---
variable_id: VAR-areainheragriland
canonical_label: "Area of inherited agricultural land (hectares)"
variable_name: areainher_agriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, areainher_agriland"
...
`areainher_agriland` is a continuous variable specifying the total area of agricultural land inherited in hectares. Only if inher_agriland=1.

## Conceptual intent

Quantifies the area of inherited agricultural land, in hectares.

## Construction notes

Use hectares (see area_agriland conversions). Only if inher_agriland=1.
