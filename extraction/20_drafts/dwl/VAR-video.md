...
# --- Identity ---
variable_id: VAR-video
canonical_label: "Ownership of a video player"
variable_name: video
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, video"
...
`video` is a binary dummy variable indicating whether the household owns a video cassette player and/or video cassette recorder (VCR), or a DVD player.

## Conceptual intent

A legacy media durable indicator included for asset-index completeness.

## Construction notes

Map the raw video/VCR/DVD ownership question to 0/1.
