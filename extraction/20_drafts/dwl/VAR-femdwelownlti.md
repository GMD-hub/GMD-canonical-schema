...
# --- Identity ---
variable_id: VAR-femdwelownlti
canonical_label: "Legal title for ownership of dwelling - female"
variable_name: fem_dwelownlti
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Main Dwelling, Ownership, fem_dwelownlti"
...
`fem_dwelownlti` is a binary dummy variable specifying whether the names of female household members are listed on the legal document specifying ownership of the dwelling.

## Conceptual intent

A gender-disaggregated tenure indicator relevant to SDG 1.4 and 5.a analysis.

## Construction notes

Derive from questions asking for the roster IDs of household members whose names appear on the dwelling's legal document; code 1 if any are female. Map to 0/1.
