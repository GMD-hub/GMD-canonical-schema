...
# --- Identity ---
variable_id: VAR-car
canonical_label: "Ownership of a car"
variable_name: car
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Means of transportation, car"
...
`car` is a binary dummy variable indicating whether the household owns a car or truck for household use.

## Conceptual intent

A major mobility and welfare asset. Commercial vehicles are excluded.

## Construction notes

Map the raw car/truck ownership question to 0/1 for household use. Exclude vehicles used for commercial purposes.
