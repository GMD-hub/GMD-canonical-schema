...
# --- Identity ---
variable_id: VAR-oxcart
canonical_label: "Ownership of an oxcart"
variable_name: oxcart
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Means of transportation, oxcart"
...
`oxcart` is a binary dummy variable indicating whether the household owns an animal cart used as a means of transport or as a farm tool.

## Conceptual intent

An animal-drawn transport and farm-tool asset common in rural settings.

## Construction notes

Map the raw oxcart/animal-cart ownership question to 0/1.
