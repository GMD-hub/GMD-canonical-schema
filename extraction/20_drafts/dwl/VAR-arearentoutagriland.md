...
# --- Identity ---
variable_id: VAR-arearentoutagriland
canonical_label: "Area of rented-out agricultural land (hectares)"
variable_name: arearentout_agriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
# --- Prerequisites ---
prerequisites:
  - variable_id: VAR-rentoutagriland
    condition: "rentout_agriland = 1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, arearentout_agriland"
...
`arearentout_agriland` is a continuous variable specifying the total area of agricultural land rented out or sharecropped in hectares. Only if rentout_agriland=1.

## Conceptual intent

Quantifies the area of agricultural land rented out or sharecropped, in hectares.

## Construction notes

Use hectares (see area_agriland conversions). Only if rentout_agriland=1.
