...
# --- Identity ---
variable_id: VAR-tvcable
canonical_label: "Ownership of cable TV"
variable_name: tv_cable
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, tv_cable"
...
`tv_cable` is a binary dummy variable indicating whether the household owns cable or dish-antenna services.

## Conceptual intent

Captures access to paid TV services (cable or satellite/dish), a marker of connectivity and consumption capacity.

## Construction notes

Only for households that reported owning a TV (tv=1). Map the cable/dish-service question to 0/1. In surveys that do not collect it, code as missing.
