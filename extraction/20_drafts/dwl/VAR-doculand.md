...
# --- Identity ---
variable_id: VAR-doculand
canonical_label: "Legal document for residential land"
variable_name: doculand
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Residential, doculand"
...
`doculand` is a binary dummy variable specifying whether the household has a legal document for their residential land. Only for landowners (ownland=1).

## Conceptual intent

A tenure-security indicator for residential land, relevant to SDG 1.4.

## Construction notes

Only for landowners (ownland=1). Map the presence of a legal document to 0/1.
