...
canonical_label: "Own agricultural land"
variable_name: ownagriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, ownagriland"
...
`ownagriland` is a binary dummy variable specifying whether a household owns agricultural land. Owned land may be by freehold, deed, customary, or government leasehold. Only for households that declared using agricultural land (agriland=1).

## Conceptual intent

A land-ownership indicator among agricultural-land users, relevant to SDG 5.a.1.

## Construction notes

Only for households that declared using agricultural land (agriland=1). Map the agricultural-land ownership question to 0/1.
