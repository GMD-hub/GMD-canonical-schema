...
canonical_label: "Use agricultural land"
variable_name: agriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, agriland"
...
`agriland` is a binary dummy variable specifying whether a household is using agricultural land according to the World Census of Agriculture 2020 classification.

## Conceptual intent

A binary use-of-agricultural-land indicator (use, not ownership), aligning with FAO's agricultural land classification.

## Construction notes

Map the agricultural-land-use question to 0/1 following the World Census of Agriculture 2020 land-use classification. This is about use, not ownership.
