...
# --- Identity ---
variable_id: VAR-areaownagriland
canonical_label: "Area of agricultural land owned (hectares)"
variable_name: area_ownagriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, area_ownagriland"
...
`area_ownagriland` is a continuous variable specifying the total area of agricultural land owned in hectares. Only if ownagriland=1.

## Conceptual intent

Quantifies the area of agricultural land owned, in hectares, among owning households.

## Construction notes

Use hectares (see area_agriland conversions). Only if ownagriland=1.
