...
# --- Identity ---
variable_id: VAR-phone
canonical_label: "Ownership of a telephone"
variable_name: phone
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, phone"
...
`phone` is a binary dummy variable indicating whether the household owns either a landline phone or a cell phone.

## Conceptual intent

Used only when the survey does not distinguish landline from cell phone ownership; it collapses both into a single telephone-access indicator.

## Construction notes

Code 1 when the household has either a landline or a cell phone. This should only be coded when the survey does not distinguish between the two; in surveys that do distinguish, code this variable as missing.
