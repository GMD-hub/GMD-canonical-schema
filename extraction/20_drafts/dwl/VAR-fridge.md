...
# --- Identity ---
variable_id: VAR-fridge
canonical_label: "Ownership of a refrigerator"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, fridge"
...
`fridge` is a binary dummy variable indicating whether the household owns a refrigerator or freezer.

## Conceptual intent

A core durable good strongly associated with household welfare and widely used in asset indices.

## Construction notes

Map the raw refrigerator-ownership question to 0/1. Refrigerators and freezers qualify; coolers, iceboxes, and ice chests do not.
