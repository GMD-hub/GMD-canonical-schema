...
# --- Identity ---
variable_id: VAR-canoe
canonical_label: "Ownership of a canoe"
variable_name: canoe
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Means of transportation, canoe"
...
`canoe` is a binary dummy variable indicating whether the household owns a canoe for household use.

## Conceptual intent

A water-transport asset relevant to river/lake communities; commercial canoes are excluded.

## Construction notes

Map the raw canoe ownership question to 0/1 for household use. Exclude canoes used for commercial purposes.
