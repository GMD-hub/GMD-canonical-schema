...
# --- Identity ---
variable_id: VAR-ricecook
canonical_label: "Ownership of a rice cooker"
variable_name: ricecook
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, ricecook"
...
`ricecook` is a binary dummy variable indicating whether the household owns a rice cooker.

## Conceptual intent

A tier-2 appliance capturing ownership of a rice cooker, a regionally relevant kitchen durable.

## Construction notes

Map the raw rice-cooker ownership question to 0/1.
