...
canonical_label: "Documented agricultural land"
variable_name: docuagriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, docuagriland"
...
`docuagriland` is a binary dummy variable specifying whether the household has a legal document for their agricultural land. Only if ownagriland=1.

## Conceptual intent

A tenure-security indicator for agricultural land, relevant to SDG 5.a.1.

## Construction notes

Only if ownagriland=1. Map the presence of a legal document to 0/1.
