...
# --- Identity ---
variable_id: VAR-radio
canonical_label: "Ownership of a radio"
variable_name: radio
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, radio"
...
`radio` is a binary dummy variable indicating whether the household owns a radio (radio, radio cassette, or 3-in-1 radio cassette player).

## Conceptual intent

A classic durable-good and information-access indicator used in asset indices.

## Construction notes

Map the raw radio-ownership question to 0/1, including radio cassette and 3-in-1 radio cassette players.
