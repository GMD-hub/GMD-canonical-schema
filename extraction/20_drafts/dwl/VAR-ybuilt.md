...
# --- Identity ---
variable_id: VAR-ybuilt
canonical_label: "Year the dwelling was built"
variable_name: ybuilt
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Main Dwelling, Facilities characteristics, ybuilt"
...
`ybuilt` is an integer variable indicating the year when the dwelling was built, using the Gregorian calendar.

## Conceptual intent

A housing-age indicator; collected for all households irrespective of ownership status when available.

## Construction notes

Record the 4-digit Gregorian year the dwelling was built. It should be gathered, when available, for all households regardless of ownership status.
