...
# --- Identity ---
variable_id: VAR-sewmach
canonical_label: "Ownership of a sewing machine"
variable_name: sewmach
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, sewmach"
...
`sewmach` is a binary dummy variable indicating whether the household owns a sewing machine.

## Conceptual intent

A durable good and potential income-generating asset tracked in the appliances section.

## Construction notes

Map the raw sewing-machine ownership question to 0/1.
