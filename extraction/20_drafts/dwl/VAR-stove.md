...
# --- Identity ---
variable_id: VAR-stove
canonical_label: "Ownership of a stove"
variable_name: stove
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, stove"
...
`stove` is a binary dummy variable indicating whether the household owns a stove (portable or fixed apparatus burning fuel or using electricity for cooking or heating), including a cooker.
...
Map the raw stove/cooker ownership question to 0/1, including portable or fixed stoves and cookers.
