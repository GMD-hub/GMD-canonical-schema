...
# --- Identity ---
variable_id: VAR-transland
canonical_label: "Right to transfer residential land"
variable_name: transland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Residential, transland"
...
`transland` is a binary dummy variable specifying whether the respondent has the right to bequeath residential land to the next generation of the family. Only for landowners (ownland=1).

## Conceptual intent

A tenure-rights indicator capturing the ability to transfer residential land.

## Construction notes

Only for landowners (ownland=1). Map the bequest/transfer-rights question to 0/1.
