...
canonical_label: "Inherited agricultural land"
variable_name: inher_agriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, inher_agriland"
...
`inher_agriland` is a binary dummy variable specifying whether a household has inherited the agricultural land they own. Only if ownagriland=1.

## Conceptual intent

Identifies acquisition by inheritance among agricultural-land-owning households, relevant to intergenerational transfer analysis.

## Construction notes

Only if ownagriland=1. Map the inheritance question to 0/1.
