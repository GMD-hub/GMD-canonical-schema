...
# --- Identity ---
variable_id: VAR-etablet
canonical_label: "Ownership of an electronic tablet"
variable_name: etablet
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, etablet"
...
`etablet` is a binary dummy variable indicating whether the household owns an electronic tablet.

## Conceptual intent

A separate ICT asset tracking tablet ownership distinct from desktop/laptop computers.

## Construction notes

Map the raw tablet-ownership question to 0/1. Tablets are recorded separately from computers.
