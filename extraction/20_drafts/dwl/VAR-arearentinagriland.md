...
# --- Identity ---
variable_id: VAR-arearentinagriland
canonical_label: "Area of rented-in agricultural land (hectares)"
variable_name: arearentin_agriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, arearentin_agriland"
...
`arearentin_agriland` is a continuous variable specifying the total area of agricultural land rented in or sharecropped in hectares. Only if rentin_agriland=1.

## Conceptual intent

Quantifies the area of agricultural land rented in or sharecropped, in hectares.

## Construction notes

Use hectares (see area_agriland conversions). Only if rentin_agriland=1.
