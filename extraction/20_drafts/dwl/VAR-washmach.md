...
# --- Identity ---
variable_id: VAR-washmach
canonical_label: "Ownership of a washing machine"
variable_name: washmach
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, washmach"
...
`washmach` is a binary dummy variable indicating whether the household owns a machine for washing clothes and household linen.

## Conceptual intent

A standard durable good in asset indices reflecting household welfare.

## Construction notes

Map the raw washing-machine ownership question to 0/1. Non-electric washing machines are not included.
