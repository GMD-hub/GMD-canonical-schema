...
# --- Identity ---
variable_id: VAR-bath
canonical_label: "Bathing facility in the dwelling"
variable_name: bath
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Main Dwelling, Facilities characteristics, bath"
...
`bath` is a binary dummy variable indicating whether the household has a separate bathing facility such as a shower or bathroom in the dwelling.
...
Map the raw bathing-facility question to 0/1. A fixed bath or shower outside the housing unit is not considered.
