...
# --- Identity ---
variable_id: VAR-cellphone
canonical_label: "Ownership of a cell phone"
variable_name: cellphone
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, cellphone"
...
`cellphone` is a binary dummy variable indicating whether anyone in the household owns a cell phone.

## Conceptual intent

Captures mobile-phone access, a key communication and financial-inclusion asset in asset-based and connectivity indicators.

## Construction notes

Map the raw cellular/mobile phone ownership question to 0/1. It records whether anyone in the household owns a cell phone, regardless of how many.
