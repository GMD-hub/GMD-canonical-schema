...
# --- Identity ---
variable_id: VAR-transdwel
canonical_label: "Right to transfer dwelling"
variable_name: transdwel
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Main Dwelling, Ownership, transdwel"
...
`transdwel` is a binary dummy variable specifying whether the respondent has the right to bequeath the dwelling to the next generation of the family.

## Conceptual intent

A tenure-rights indicator capturing the ability to transfer (bequeath) the dwelling.
