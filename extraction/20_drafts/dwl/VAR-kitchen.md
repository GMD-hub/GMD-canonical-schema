...
# --- Identity ---
variable_id: VAR-kitchen
canonical_label: "Separate kitchen in dwelling"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Main Dwelling, Facilities characteristics, kitchen"
...
`kitchen` is a binary dummy variable indicating whether the household has a separate kitchen in the dwelling.

## Conceptual intent

A housing-facility and sanitation indicator; a separate kitchen implies an independent space set aside for cooking inside the dwelling.

## Construction notes

Map the raw separate-kitchen question to 0/1. A kitchenette or an outer space for cooking is not considered a kitchen.
