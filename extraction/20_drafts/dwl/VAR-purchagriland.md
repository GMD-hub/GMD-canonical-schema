...
canonical_label: "Purchased agricultural land"
variable_name: purch_agriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, purch_agriland"
...
`purch_agriland` is a binary dummy variable specifying whether a household has purchased the agricultural land they own. Only if ownagriland=1.

## Conceptual intent

Identifies acquisition by purchase among agricultural-land-owning households, relevant to land-market and tenure analysis.

## Construction notes

Only if ownagriland=1. Map the purchase question to 0/1.
