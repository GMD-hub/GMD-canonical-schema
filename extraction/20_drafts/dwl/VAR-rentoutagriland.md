...
canonical_label: "Rent out agricultural land"
variable_name: rentout_agriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, rentout_agriland"
...
`rentout_agriland` is a binary dummy variable specifying whether any of the agricultural land a household uses is rented-out land or sharecropped. Only if ownagriland=1.

## Conceptual intent

Captures land rented out or sharecropped, indicating how owned land is used by others.

## Construction notes

Only if ownagriland=1. This refers to land owned by the household but cultivated or used by someone else. Map to 0/1.
