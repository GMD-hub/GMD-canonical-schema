...
# --- Identity ---
variable_id: VAR-rentinagriland
canonical_label: "Rent in agricultural land"
variable_name: rentin_agriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, rentin_agriland"
...
`rentin_agriland` is a binary dummy variable specifying whether any of the agricultural land a household uses is rented-in land or sharecropped. Only if ownagriland=1.

## Conceptual intent

Captures land rented in or sharecropped, indicating land cultivated by the household but owned by others.

## Construction notes

Only if ownagriland=1. This refers to land owned by others but cultivated or used by the household under fixed rental, sharecropping, or similar arrangements. Map to 0/1.
