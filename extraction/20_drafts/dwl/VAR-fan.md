...
# --- Identity ---
variable_id: VAR-fan
canonical_label: "Ownership of an electric fan"
variable_name: fan
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, fan"
...
`fan` is a binary dummy variable indicating whether the household owns a fan operated by electricity.

## Conceptual intent

A tier-2 appliance used as a modest welfare/asset indicator.

## Construction notes

Map the raw electric-fan ownership question to 0/1. Only electricity-operated fans count.
