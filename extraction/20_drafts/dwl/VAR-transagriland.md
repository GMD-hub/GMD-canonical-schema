...
# --- Identity ---
variable_id: VAR-transagriland
canonical_label: "Right to transfer agricultural land"
variable_name: transagriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, transagriland"
...
`transagriland` is a binary dummy variable specifying whether the respondent has the right to bequeath agricultural land to the next generation of the family. Only if ownagriland=1.

## Conceptual intent

A tenure-rights indicator capturing the ability to transfer agricultural land.

## Construction notes

Only if ownagriland=1. Map the bequest/transfer-rights question to 0/1.
