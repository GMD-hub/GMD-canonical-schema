...
# --- Identity ---
variable_id: VAR-boat
canonical_label: "Ownership of a boat"
variable_name: boat
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Means of transportation, boat"
...
`boat` is a binary dummy variable indicating whether the household owns a boat for household use.

## Conceptual intent

A mobility asset relevant to fishing and water-transport communities; commercial boats are excluded.

## Construction notes

Map the raw boat ownership question to 0/1 for household use. Exclude boats used for commercial purposes.
