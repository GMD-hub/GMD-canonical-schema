...
# --- Identity ---
variable_id: VAR-floorcs
canonical_label: "Main material used for floor (country-specific)"
variable_name: floorcs
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Main Dwelling, Materials, floorcs"
...
`floorcs` is a string variable recording the country-specific main floor material, with the label translated to English.

## Conceptual intent

Preserves the country-specific floor-material category alongside the harmonized `floor` code.
