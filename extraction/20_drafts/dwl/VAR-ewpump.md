...
# --- Identity ---
variable_id: VAR-ewpump
canonical_label: "Ownership of an electric water pump"
variable_name: ewpump
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, ewpump"
...
`ewpump` is a binary dummy variable indicating whether the household owns an electric water pump.

## Conceptual intent

A tier-2 asset representing water-infrastructure access and productive capacity.

## Construction notes

Map the raw electric-water-pump ownership question to 0/1.
