...
# --- Identity ---
variable_id: VAR-areadocuagriland
canonical_label: "Area of documented agricultural land (hectares)"
variable_name: area_docuagriland
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Land ownership, Agricultural, area_docuagriland"
...
`area_docuagriland` is a continuous variable specifying the total area of agricultural land owned with legal documentation in hectares. Only if docuagriland=1.

## Conceptual intent

Quantifies the area of documented agricultural land, in hectares.

## Construction notes

Use hectares (see area_agriland conversions). Only if docuagriland=1.
