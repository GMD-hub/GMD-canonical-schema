...
# --- Identity ---
variable_id: VAR-bcycle
canonical_label: "Ownership of a bicycle"
variable_name: bcycle
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Means of transportation, bcycle"
...
`bcycle` is a binary dummy variable indicating whether the household owns a bicycle.
...
Map the raw bicycle ownership question to 0/1. Motored bicycles are classified as motorcycles, not bicycles.
