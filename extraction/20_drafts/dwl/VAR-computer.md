...
# --- Identity ---
variable_id: VAR-computer
canonical_label: "Ownership of a computer"
variable_name: computer
module_id: MOD-DWL
gmd_version: "3.0"
schema_version: "0.1"
status: draft
...
provenance:
  ...
  source_section: "Assets and Dwellings (DWL), Mapping and Description of Variables, Assets, Appliances, computer"
...
`computer` is a binary dummy variable indicating whether the household owns a computer, including desktop and laptop computers.

## Conceptual intent

A standard ICT asset that enters asset indices and digital-access indicators.

## Construction notes

Map the raw computer-ownership question to 0/1. Both desktop and laptop computers qualify; ownership by any household member counts.
