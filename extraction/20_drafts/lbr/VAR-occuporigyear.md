...
# ================================================================
variable_id: VAR-occuporigyear
canonical_label: Original occupation classification, primary job (12-month ref period)
variable_name: occup_orig_year
module_id: MOD-LBR
gmd_version: '3.0'
schema_version: '0.1'
status: draft
...
provenance:
  ...
  notes: 12-month reference period. This section must be filled only for those individuals who responded
    ...
    a 7-day reference period. Primary job family, 12-month reference period. Original occupation code,
    no recoding. Add external_standards ISCO where ISCO used.
---
## Definition

`occup_orig_year` is a categorical variable recording the original occupation code in the last 12 months for the main job, with no recoding. Labels should have spaces around hyphens and be written in full.

## Conceptual intent

occup_orig_year preserves the 12-month primary job's original occupation classification.
