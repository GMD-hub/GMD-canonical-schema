...
| `extraction_pipeline/` | Deterministic extraction pipeline | `extraction/config/`, `schema/extraction/`, legacy country input adapters | Preflight, source resolution, AST parsing, gates, agents, orchestrator, and country input extraction draft generation |
...
| `requirements.txt` | Python dependencies | None | Pydantic 2, PyYAML, pytest, loguru, and openpyxl environment |
