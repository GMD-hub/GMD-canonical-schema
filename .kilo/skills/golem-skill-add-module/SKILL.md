---
name: golem-skill-add-module
description: "Add a module to an existing golem Shiny application. Triggers on: - \"add a module\" - \"create a module\" - \"add a golem module\" Do not trigger on: - when the user is not working inside a golem app"
---
