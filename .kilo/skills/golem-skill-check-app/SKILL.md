---
name: golem-skill-check-app
description: "Check a golem Shiny application for package issues. Triggers on: - \"check my golem app\" - \"run R CMD check\" - \"validate the package\" Do not trigger on: - when the user is not working inside a golem app"
---
