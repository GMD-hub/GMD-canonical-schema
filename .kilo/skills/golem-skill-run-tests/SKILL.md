---
name: golem-skill-run-tests
description: "Run tests for a golem Shiny application. Triggers on: - \"run the tests\" - \"test my golem app\" - \"run devtools test\" Do not trigger on: - when the user is not working inside a golem app"
---
