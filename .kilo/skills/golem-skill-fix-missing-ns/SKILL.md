---
name: golem-skill-fix-missing-ns
description: "Validate that all module input/output IDs are properly namespaced. Triggers on: - \"check my modules for missing ns\" - \"find missing ns in modules\" - \"validate module namespaces\" Do not trigger on: - when the user is not working inside a golem app"
---
