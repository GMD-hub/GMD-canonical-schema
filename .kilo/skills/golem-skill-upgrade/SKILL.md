---
name: golem-skill-upgrade
description: "Upgrades the golem Shiny app with the newest golem package features. Triggers on: - \"upgrade my Shiny app\" - \"upgrade app\" - \"upgrade Shiny app\" - \"upgrade with newest golem features\" - \"upgrade to newest golem features\" - \"update my Shiny app\" - \"update app\" - \"update Shiny app\" - \"update with newest golem features\" - \"update to newest golem features\" Do not trigger on: - if outside an R Shiny app - if outside an R Shiny app which is not golem based"
---
